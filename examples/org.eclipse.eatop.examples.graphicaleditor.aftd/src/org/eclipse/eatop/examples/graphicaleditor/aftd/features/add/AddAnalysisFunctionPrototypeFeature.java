...
public class AddAnalysisFunctionPrototypeFeature extends AbstractAddShapeFeature {
	...
	public PictogramElement add(IAddContext context) {
		AnalysisFunctionPrototype componentTypeToAdd = (AnalysisFunctionPrototype) context.getNewObject();
