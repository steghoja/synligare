 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.aftd.remove;
...
public class RemoveFunctionConnectorFeature extends DefaultRemoveFeature {
	...
	public void preRemove(IRemoveContext context) {
		...
		AnalysisFunctionType model = (AnalysisFunctionType) getDiagram()
		...
		FunctionConnector[] fcArray = (FunctionConnector[]) fConnector
				.toArray();
