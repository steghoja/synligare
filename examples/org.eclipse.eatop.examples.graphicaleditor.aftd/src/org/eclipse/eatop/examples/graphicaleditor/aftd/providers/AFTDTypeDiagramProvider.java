...
public class AFTDTypeDiagramProvider extends AbstractDiagramTypeProvider {

	public static int counter = 50;
	public static int y = 50;
	private IToolBehaviorProvider[] toolBehaviorProviders;
	public static String DIAGRAM_TYPE_ID = "org.eclipse.eatop.examples.graphicaleditor.aftd.diagramType";

	public AFTDTypeDiagramProvider() {
		setFeatureProvider(new AFTDFeatureProvider(this));
	}

	@Override
	public IToolBehaviorProvider[] getAvailableToolBehaviorProviders() {
		if (toolBehaviorProviders == null) {
			toolBehaviorProviders = new IToolBehaviorProvider[] { new AFTDToolBehaviorProvider(
					this) };
		}
	...
	public void getports() {
		...
		if (parentBO instanceof FunctionalDevice) {
			FunctionalDevice newAFT = (FunctionalDevice) parentBO;
		...
		} else if (parentBO instanceof AnalysisFunctionType) {

			AnalysisFunctionType newAFT = (AnalysisFunctionType) parentBO;
			EList<FunctionPort> portList = newAFT.getPort();
			for (FunctionPort h : portList) {
