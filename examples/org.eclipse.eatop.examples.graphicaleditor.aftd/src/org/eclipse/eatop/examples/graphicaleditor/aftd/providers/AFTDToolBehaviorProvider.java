...
public class AFTDToolBehaviorProvider extends DefaultToolBehaviorProvider {

	public AFTDToolBehaviorProvider(IDiagramTypeProvider diagramTypeProvider) {
	...
	public IDecorator[] getDecorators(PictogramElement pe) {
	   ...
	   if (bo instanceof FunctionFlowPort) {
  	           IDecorator imageRenderingDecorator =
  		                new ImageDecorator(
  		                    AFTDImageProvider.IMAGE_FunctionFlowPort);
  		            return new IDecorator[] { imageRenderingDecorator };
  		        	    }
	       else if (bo instanceof FunctionClientServerPort) {
  	           IDecorator imageRenderingDecorator =
  		                new ImageDecorator(
  		                    AFTDImageProvider.IMAGE_FunctionClientServerPort);
  		            return new IDecorator[] { imageRenderingDecorator };
  		        	    }
	       else if (bo instanceof FunctionPowerPort) {
  	           IDecorator imageRenderingDecorator =
  		                new ImageDecorator(
  		                    AFTDImageProvider.IMAGE_FunctionPowerPort);
  		            return new IDecorator[] { imageRenderingDecorator };
  		        	    }
	       else if (bo instanceof AnalysisFunctionPrototype) {
  	           IDecorator imageRenderingDecorator =
  		                new ImageDecorator(
  		                    AFTDImageProvider.IMAGE_AnalysisFunctionPrototype);
  		            return new IDecorator[] { imageRenderingDecorator };
  		        	    }
