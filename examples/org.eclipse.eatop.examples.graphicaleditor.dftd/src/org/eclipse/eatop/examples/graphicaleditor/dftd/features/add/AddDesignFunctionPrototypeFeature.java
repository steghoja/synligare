...
public class AddDesignFunctionPrototypeFeature extends AbstractAddShapeFeature {
	private static final IColorConstant DesignFunctionPrototype_TEXT_FOREGROUND = IColorConstant.BLACK;
	...
	public boolean canAdd(IAddContext context) {
		// check if user wants to add a DesignFunctionPrototype
	...
	//  SHAPE WITH TEXT for EAPackageType
        {
        	...
        	//add Text 
             ...
             text1.setForeground(manageColor(DesignFunctionPrototype_TEXT_FOREGROUND));
