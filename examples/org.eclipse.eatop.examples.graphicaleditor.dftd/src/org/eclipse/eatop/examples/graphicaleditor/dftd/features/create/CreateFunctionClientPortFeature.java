...
public class CreateFunctionClientPortFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Function Client Port";
	 
	   private static final String USER_QUESTION = "Enter new Function Client Port name";
	   
	public CreateFunctionClientPortFeature(IFeatureProvider fp) {
		super(fp, "FunctionClientPort", "Create Function Client Port");
	}

	@Override
	public String getCreateImageId() {
		return DFTDImageProvider.IMAGE_FunctionClientServerPort;
	}
...
//    	return false;
	...
	public Object[] create(ICreateContext context) {
        ...
        newFunctionClientServerPort.setKind(ClientServerKind.CLIENT);
