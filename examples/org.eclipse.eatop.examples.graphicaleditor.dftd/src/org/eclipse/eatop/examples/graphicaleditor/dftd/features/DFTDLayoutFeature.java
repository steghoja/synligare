 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.dftd.features;
...
public class DFTDLayoutFeature extends AbstractLayoutFeature {
	 private static final int MIN_HEIGHT = 50;
	 
	    private static final int MIN_WIDTH = 80;

	public DFTDLayoutFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		// return true, if pictogram element is linked to an EClass
	       ...
	       return businessObjects.size() == 1 
	              ...
	              ||businessObjects.get(0) instanceof FunctionalSafetyConcept
	              ||businessObjects.get(0) instanceof TechnicalSafetyConcept
	              ||businessObjects.get(0) instanceof RequirementsModel
	              ||businessObjects.get(0) instanceof SystemModel
	              ||businessObjects.get(0) instanceof VehicleLevel
	              ||businessObjects.get(0) instanceof AnalysisLevel
	              ||businessObjects.get(0) instanceof DesignLevel
	              ||businessObjects.get(0) instanceof EAPackage
	              ||businessObjects.get(0) instanceof AnalysisFunctionType
	              ||businessObjects.get(0) instanceof FunctionalDevice
	              ||businessObjects.get(0) instanceof FunctionFlowPort;
	}
