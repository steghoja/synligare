...
public class DFTDPropertySection extends GFPropertySection implements
		ITabbedPropertyConstants {
	private Text nameText;

	public DFTDPropertySection() {
	}
	...
	public void refresh() {
		...
		if (pe != null) {
			...
			if (bo instanceof DesignFunctionPrototype) {
				...
				shortname = ((FunctionPort) bo).getShortName();
			}
			...
			nameText.addModifyListener(new ModifyListener() {
				...
				public void modifyText(ModifyEvent e) {
					...
					if (pe != null) {
						...
						String shortname = null;
						if (bo instanceof DesignFunctionPrototype) {
							shortname = ((DesignFunctionPrototype) bo)
									.getShortName();
						} else if (bo instanceof FunctionPort) {
							shortname = ((FunctionPort) bo).getShortName();
						}
						...
						public void execute(IContext context) {
							...
							if (pe != null) {
								...
								if (bo instanceof DesignFunctionPrototype) {
									...
									FunctionPort eClass = (FunctionPort) bo;
									eClass.setShortName(typedValue);
								}
