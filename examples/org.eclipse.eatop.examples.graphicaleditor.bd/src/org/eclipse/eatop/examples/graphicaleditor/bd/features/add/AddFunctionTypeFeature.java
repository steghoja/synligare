...
import org.eclipse.eatop.examples.graphicaleditor.bd.provider.BDFeatureProvider;
...
public class AddFunctionTypeFeature extends AbstractAddShapeFeature {
	...
	public AddFunctionTypeFeature(IFeatureProvider fp) {
		super(fp);
	}

	@Override
	public boolean canAdd(IAddContext context) {
		// check if user wants to add a FunctionType
		if (context.getNewObject() instanceof FunctionType) {
	...
	public PictogramElement add(IAddContext context) {
		FunctionType componentTypeToAdd = (FunctionType) context.getNewObject();
		...
		BDFeatureProvider.timeOfNewFunctionType = System.currentTimeMillis();
