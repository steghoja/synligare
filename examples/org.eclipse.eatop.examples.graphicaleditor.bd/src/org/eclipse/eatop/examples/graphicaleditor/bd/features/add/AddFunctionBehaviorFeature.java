...
public class AddFunctionBehaviorFeature extends AbstractAddShapeFeature {
	...
	public AddFunctionBehaviorFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context.getNewObject() instanceof FunctionBehavior) {
	...
	public PictogramElement add(IAddContext context) {
		  FunctionBehavior addedFunctionBehavior = (FunctionBehavior) context.getNewObject();
	      ...
	      final  ContainerShape containerShape =
	       ...
	       final IGaService gaService = Graphiti.getGaService();
	 ...
	 
	        {
	            ...
	            if (((EObject) addedFunctionBehavior).eResource() == null) {
	                     getDiagram().eResource().getContents().add((EObject) addedFunctionBehavior);
	            }
	            // create link and wire it
	            link(containerShape, addedFunctionBehavior);
	        }
	       
	        // SHAPE WITH TEXT for FunctionBehaviorType
	        {
	        	 // create shape for text  
	            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
	        	//add Text 
	             Text text1=gaService.createText(shape, ((EObject) addedFunctionBehavior).eClass().getName());
	             ...
	             // create link and wire it
		            link(shape, addedFunctionBehavior);
	        }
	        // SHAPE WITH TEXT for ShortName
	        {
	            ...
	            Text text = gaService.createText(shape, addedFunctionBehavior.getShortName());
