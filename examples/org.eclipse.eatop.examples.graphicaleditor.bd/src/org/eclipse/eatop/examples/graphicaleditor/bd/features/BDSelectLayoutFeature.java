...
package org.eclipse.eatop.examples.graphicaleditor.bd.features;
...
public class BDSelectLayoutFeature extends AbstractLayoutFeature {
	...
	public BDSelectLayoutFeature(IFeatureProvider fp) 
	{
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return  businessObjects.get(0) instanceof Mode||
				businessObjects.get(0) instanceof ModeGroup||
				businessObjects.get(0) instanceof FunctionBehavior||
				businessObjects.get(0) instanceof FunctionTrigger||
				...
				businessObjects.get(0) instanceof AnalysisFunctionType|| //FunctionType
				businessObjects.get(0) instanceof DesignFunctionType; //FunctionType
