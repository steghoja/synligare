...
public class RemoveFunctionTriggerToFunctionType extends DefaultRemoveFeature {

	public RemoveFunctionTriggerToFunctionType(IFeatureProvider fp) {
		super(fp);
	}
	@Override
	public void preRemove(IRemoveContext context) {
		...
		Assert.isTrue(getBusinessObjectForPictogramElement(element.getEnd().getParent()) 
				instanceof FunctionType, "The start element isn't a FunctionType!");
