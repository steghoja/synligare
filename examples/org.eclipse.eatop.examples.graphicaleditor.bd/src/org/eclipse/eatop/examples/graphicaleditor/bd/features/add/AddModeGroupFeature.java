...
public class AddModeGroupFeature extends AbstractAddShapeFeature {
	...
	public AddModeGroupFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context.getNewObject() instanceof ModeGroup) {
	...
	public PictogramElement add(IAddContext context) {
		  ModeGroup addedModeGroup = (ModeGroup) context.getNewObject();
	      ...
	      final  ContainerShape containerShape =
	       ...
	       final IGaService gaService = Graphiti.getGaService();
	 ...
	 
	        {
	            ...
	            if (((EObject) addedModeGroup).eResource() == null) {
	                     getDiagram().eResource().getContents().add((EObject) addedModeGroup);
	            }
	            // create link and wire it
	            link(containerShape, addedModeGroup);
	        }
	        // SHAPE WITH TEXT for ModeGroupType
	        {
	        	...
	        	//add Text 
	             Text text1=gaService.createText(shape, ((EObject) addedModeGroup).eClass().getName());
	        ...
	        // SHAPE WITH TEXT for ShortName
	        {
	            ...
	            Text text = gaService.createText(shape, addedModeGroup.getShortName());
