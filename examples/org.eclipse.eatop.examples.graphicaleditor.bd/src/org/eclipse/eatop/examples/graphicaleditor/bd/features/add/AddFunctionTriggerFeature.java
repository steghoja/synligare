...
public class AddFunctionTriggerFeature extends AbstractAddShapeFeature {
	...
	public AddFunctionTriggerFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context.getNewObject() instanceof FunctionTrigger) {
	...
	public PictogramElement add(IAddContext context) {
		  FunctionTrigger addedFunctionTrigger = (FunctionTrigger) context.getNewObject();
	      ...
	      final  ContainerShape containerShape =
	       ...
	       final IGaService gaService = Graphiti.getGaService();
	 ...
	 
	        {
	            ...
	            if (addedFunctionTrigger.eResource() == null) {
	                     getDiagram().eResource().getContents().add(addedFunctionTrigger);
	            }
	            // create link and wire it
	            link(containerShape, addedFunctionTrigger);
	        }
	       
	        // SHAPE WITH TEXT for FunctionTriggerType
	        {
	        	 // create shape for text  
	            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
	        	//add Text 
	             Text text1=gaService.createText(shape, addedFunctionTrigger.eClass().getName());
	             ...
	             // create link and wire it
		            link(shape, addedFunctionTrigger);
	        }
	        // SHAPE WITH TEXT for ShortName
	        {
	            ...
	            Text text = gaService.createText(shape, addedFunctionTrigger.getShortName());
