...
public class AnalysisFunctionPrototypeLayout extends AbstractLayoutFeature {
	...
	public AnalysisFunctionPrototypeLayout(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		if (businessObjects.get(0) instanceof AnalysisFunctionPrototype
				|| businessObjects.get(0) instanceof DesignFunctionPrototype
	...
	public boolean layout(final ILayoutContext context) {
			...
			if (containerWidth != size.getWidth()) {
				...
				if (graphicsAlgorithm instanceof Polyline) {
					...
					Point newSecondPoint = gaService.createPoint(
							containerWidth + 10 / 2, secondPoint.getY());
		...
		for (GraphicsAlgorithm child : containerGa
			...
			gaService.setLocationAndSize(child, 10 / 2, 10 / 2, containerWidth,
					containerHeight);
			anythingChanged = true;
		}
