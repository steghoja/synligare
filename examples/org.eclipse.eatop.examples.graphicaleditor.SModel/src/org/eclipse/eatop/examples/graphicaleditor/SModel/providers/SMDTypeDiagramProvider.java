...
public class SMDTypeDiagramProvider extends AbstractDiagramTypeProvider {

	private IToolBehaviorProvider[] toolBehaviorProviders;
	public static String DIAGRAM_TYPE_ID = "org.eclipse.eatop.examples.graphicaleditor.SModel.diagramType";

	public SMDTypeDiagramProvider() {
		setFeatureProvider(new SMDFeatureProvider(this));
	}

	@Override
	public IToolBehaviorProvider[] getAvailableToolBehaviorProviders() {
		if (toolBehaviorProviders == null) {
			toolBehaviorProviders = new IToolBehaviorProvider[] { new SMDToolBehaviorProvider(
					this) };
		}
