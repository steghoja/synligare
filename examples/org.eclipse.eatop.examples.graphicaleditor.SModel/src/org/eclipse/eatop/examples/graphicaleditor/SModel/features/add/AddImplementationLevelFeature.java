...
public class AddImplementationLevelFeature extends AbstractAddShapeFeature {
	...
	public AddImplementationLevelFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof ImplementationLevel) {
					...
					if (smC.getLink() != null)
						if (smC.getLink().getBusinessObjects().get(0) instanceof SystemModel)
							for (Shape s : ((ContainerShape) smC).getChildren())
								if (s.getLink() != null)
									if (s.getLink().getBusinessObjects().get(0) instanceof ImplementationLevel)
	...
	public PictogramElement add(IAddContext context) {
		final ImplementationLevel addedAnalysisLevel = (ImplementationLevel) context
				.getNewObject();
