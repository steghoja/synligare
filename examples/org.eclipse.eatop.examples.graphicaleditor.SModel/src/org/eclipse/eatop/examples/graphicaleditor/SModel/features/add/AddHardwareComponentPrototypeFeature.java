...
public class AddHardwareComponentPrototypeFeature extends
	...
	public AddHardwareComponentPrototypeFeature(IFeatureProvider fp) {
	...
	{
		if (context.getNewObject() instanceof HardwareComponentPrototype) 
		{
						...
						.get(0) instanceof DesignLevel) 
		 {
					...
					// Any DesignLevel contains container of new HardwareComponentPrototype
					// Systemmodels
									...
									for (Shape cs3 : ((ContainerShape) cs2)
										...
										if (cs3.getLink() != null) {
											if (cs3.getLink().getBusinessObjects()
													.get(0) instanceof HardwareComponentPrototype) {
					...
					// Any DesignLevel contains business object of new HardwareComponentPrototype
					// Systemmodels
					for (Shape cs : context.getTargetContainer().getContainer()
							.getContainer().getChildren()) {
						// Designlevel
						...
						DesignLevel currentfm = (DesignLevel) cs2.getLink()
									...
									if(currentfm.getHardwareDesignArchitecture() != null&&
											targetfm.getHardwareDesignArchitecture() !=null)
									if (currentfm.getHardwareDesignArchitecture().equals(
											context.getNewObject())
											)
										// Target DesignLevel contains business object of new
										// HardwareComponentPrototype
										if (targetfm.getHardwareDesignArchitecture().equals(
												context.getNewObject())
												)
											return true;
								}}}}
	...
	public PictogramElement add(IAddContext context) {
		HardwareComponentPrototype componentTypeToAdd = (HardwareComponentPrototype) context
				.getNewObject();
