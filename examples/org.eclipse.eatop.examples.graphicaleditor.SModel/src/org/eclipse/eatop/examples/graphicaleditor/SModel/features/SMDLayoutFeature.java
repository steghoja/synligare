...
public class SMDLayoutFeature extends AbstractLayoutFeature {
	private static final int MIN_HEIGHT = 50;

	private static final int MIN_WIDTH = 80;

	public SMDLayoutFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.size() == 1
				...
				|| businessObjects.get(0) instanceof ImplementationLevel
				|| businessObjects.get(0) instanceof Allocation;
