...
public class AddFeatureFlawToItemFeature extends AbstractAddFeature {
    ...
    public AddFeatureFlawToItemFeature (IFeatureProvider fp) {
        super(fp);
    }
...
//     private Polygon createTriangularShape(GraphicsAlgorithmContainer gaContainer) {
//		IGaService gaService = Graphiti.getGaService();
//		Polygon polygon = gaService.createPolygon(gaContainer, new int[] { -30,0,-15, 10, 1, 0, -15, -10,-30,0 });
