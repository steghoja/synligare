...
public class CreateEnvironmentFeature extends AbstractCreateConnectionFeature {
	public static int lock = 0;
	public CreateEnvironmentFeature(IFeatureProvider fp) {
		super(fp, "HazardousEvent to OperationalSituationEnvironment", "Create Environment");
	}
