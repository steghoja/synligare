...
public class AddHazardToFeatureFlawFeature extends AbstractAddFeature {
	private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(98, 131, 167);
	public AddHazardToFeatureFlawFeature(IFeatureProvider fp) {
		super(fp);
	}
