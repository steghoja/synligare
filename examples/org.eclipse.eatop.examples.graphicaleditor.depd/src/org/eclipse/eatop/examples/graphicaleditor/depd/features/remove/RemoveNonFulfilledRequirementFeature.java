...
public class RemoveNonFulfilledRequirementFeature extends DefaultRemoveFeature {

	public RemoveNonFulfilledRequirementFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public void preRemove(IRemoveContext context) {
		...
		Assert.isTrue(getBusinessObjectForPictogramElement(element.getStart().getParent()) instanceof FeatureFlaw, "The start element isn't a FeatureFlaw!");
		FeatureFlaw source = (FeatureFlaw) getBusinessObjectForPictogramElement(element.getStart().getParent());
