...
public class AddSafetyGoalToRequirementFeature extends AbstractAddFeature {
	 private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(98, 131, 167);
    public AddSafetyGoalToRequirementFeature (IFeatureProvider fp) {
        super(fp);
    }
