...
public class CreateSafetyGoalToModeFeature extends
		AbstractCreateConnectionFeature {

	public CreateSafetyGoalToModeFeature(IFeatureProvider fp) {
		super(fp,  "SafetyGoal to Mode", "Create SafetyGoal to Mode");
	}
