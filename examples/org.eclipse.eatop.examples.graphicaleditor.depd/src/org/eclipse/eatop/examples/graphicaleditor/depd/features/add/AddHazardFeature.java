...
public class AddHazardFeature extends AbstractAddShapeFeature {
	...
	public AddHazardFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context.getNewObject() instanceof Hazard) {
	...
	public PictogramElement add(IAddContext context) {
		  Hazard addedHazard = (Hazard) context.getNewObject();
	      ...
	      final  ContainerShape containerShape =
	       ...
	       final IGaService gaService = Graphiti.getGaService();
	 ...
	 
	        {
	            ...
	            if (addedHazard.eResource() == null) {
	                     getDiagram().eResource().getContents().add(addedHazard);
	            }
	            // create link and wire it
	            link(containerShape, addedHazard);
	        }
	        ...
	        // SHAPE WITH TEXT for ShortName
	        {
	            ...
	            Text text = gaService.createText(shape, addedHazard.getShortName());
	     ...
	     // SHAPE WITH TEXT for HazardType
	        {
	            ...
	            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
	        	//add Text 
	             Text text1=gaService.createText(shape, addedHazard.eClass().getName());
