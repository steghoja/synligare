...
public class AddFeatureFlawFeature extends AbstractAddShapeFeature{
	...
	public AddFeatureFlawFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context.getNewObject() instanceof FeatureFlaw) {
	...
	public PictogramElement add(IAddContext context) {
		FeatureFlaw addedFeatureFlaw = (FeatureFlaw) context.getNewObject();
      ...
      final  ContainerShape containerShape =
       ...
       final IGaService gaService = Graphiti.getGaService();
 ...
 
        {
            ...
            if (addedFeatureFlaw.eResource() == null) {
                     getDiagram().eResource().getContents().add(addedFeatureFlaw);
            }
            // create link and wire it
            link(containerShape, addedFeatureFlaw);
        }
        ...
        // SHAPE WITH TEXT for ShortName
        {
            ...
            Text text = gaService.createText(shape, addedFeatureFlaw.getShortName());
     ...
     // SHAPE WITH TEXT for FeatureFlawType
        {
        	 // create shape for text  
            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
        	//add Text 
             Text text1=gaService.createText(shape, addedFeatureFlaw.eClass().getName());
