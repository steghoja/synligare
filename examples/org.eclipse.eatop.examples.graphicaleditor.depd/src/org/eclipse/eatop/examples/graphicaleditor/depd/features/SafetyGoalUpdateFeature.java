...
public class SafetyGoalUpdateFeature extends AbstractUpdateFeature {

	public SafetyGoalUpdateFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canUpdate(IUpdateContext context) {
        ...
        return (bo instanceof SafetyGoal);
	}
	...
	public IReason updateNeeded(IUpdateContext context) {
        ...
        if (bo instanceof SafetyGoal) {
        	SafetyGoal req = (SafetyGoal) bo;
            businessName1 = req.getShortName();
            businessName2 = req.getHazardClassification().toString();
	...
	public boolean update(IUpdateContext context) {
        ...
        Object bo = getBusinessObjectForPictogramElement(pictogramElement);
        if (bo instanceof SafetyGoal) {
        	SafetyGoal qr = (SafetyGoal) bo;
            businessName1 = qr.getShortName();
            businessName2 = qr.getHazardClassification().toString();
