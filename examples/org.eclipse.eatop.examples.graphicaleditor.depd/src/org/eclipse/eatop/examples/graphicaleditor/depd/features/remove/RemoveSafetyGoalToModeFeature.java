...
public class RemoveSafetyGoalToModeFeature extends DefaultRemoveFeature {

	public RemoveSafetyGoalToModeFeature(IFeatureProvider fp) {
		super(fp);
	}
	@Override
	public void preRemove(IRemoveContext context) {
		...
		EReference referenceId = Eastadl21Factory.eINSTANCE.getEastadl21Package().getSafetyGoal_SafeState();
