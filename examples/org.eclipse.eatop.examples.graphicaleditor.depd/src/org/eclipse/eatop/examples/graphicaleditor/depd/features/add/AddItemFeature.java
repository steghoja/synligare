...
public class AddItemFeature extends AbstractAddShapeFeature{
	 private static final IColorConstant E_CLASS_TEXT_FOREGROUND =
			...
			public PictogramElement add(IAddContext context) {
				Item addedItem = (Item) context.getNewObject();
		      ...
		      final  ContainerShape containerShape =
		       ...
		       final IGaService gaService = Graphiti.getGaService();
		 ...
		 
		        {
		            ...
		            if (addedItem.eResource() == null) {
		                     getDiagram().eResource().getContents().add(addedItem);
		            }
		            // create link and wire it
		            link(containerShape, addedItem);
		        }
		        ...
		        // SHAPE WITH TEXT for ShortName
		        {
		            ...
		            Text text = gaService.createText(shape, addedItem.getShortName());
		     ...
		     // SHAPE WITH TEXT for ItemType
		        {
		            ...
		            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
		        	//add Text 
		             Text text1=gaService.createText(shape, addedItem.eClass().getName());
		     ...
		     // SHAPE WITH TEXT for developementCategory
		        {
		        	 // create shape for text  
		            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
		        	//add Text 2
		             Text text2=gaService.createText(shape, addedItem.getDevelopmentCategory().getName());
