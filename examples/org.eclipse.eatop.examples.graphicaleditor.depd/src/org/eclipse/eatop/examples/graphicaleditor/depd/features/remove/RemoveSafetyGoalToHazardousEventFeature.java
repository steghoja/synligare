...
public class RemoveSafetyGoalToHazardousEventFeature extends
		DefaultRemoveFeature {

	public RemoveSafetyGoalToHazardousEventFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public void preRemove(IRemoveContext context) {
		...
		Assert.isTrue(getBusinessObjectForPictogramElement(element.getEnd().getParent()) instanceof HazardousEvent, "The start element isn't a HazardousEvent!");
		HazardousEvent target = (HazardousEvent) getBusinessObjectForPictogramElement(element.getEnd().getParent());
