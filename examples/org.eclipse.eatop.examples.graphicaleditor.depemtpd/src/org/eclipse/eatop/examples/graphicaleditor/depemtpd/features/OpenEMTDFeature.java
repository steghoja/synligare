 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.depemtpd.features;
...
public class OpenEMTDFeature extends AbstractDrillDownFeature {

	private IPeService peService;
	private Collection<Diagram> diagrams;

	public OpenEMTDFeature(IFeatureProvider fp) {
		super(fp);
	...
	public void execute(ICustomContext context) {
		...
		if (elements.length == 1) {
			...
			if (linkedDiagrams.size() == 0) {
				...
				Diagram diagram = peService.createDiagram("org.eclipse.eatop.examples.graphicaleditor.emtd", "ErrorModelType diagram", true);
