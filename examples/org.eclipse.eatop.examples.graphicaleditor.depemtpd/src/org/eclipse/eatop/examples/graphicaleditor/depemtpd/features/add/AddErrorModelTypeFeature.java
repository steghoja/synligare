 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.depemtpd.features.add;
...
public class AddErrorModelTypeFeature extends AbstractAddShapeFeature {
	...
	public AddErrorModelTypeFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		// check if user wants to add a ErrorModelType
	...
	{
		ErrorModelType componentTypeToAdd = (ErrorModelType) context.getNewObject();
