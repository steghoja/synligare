...
public class CreateFaultInPortFeature extends AbstractCreateFeature {
	...
	public CreateFaultInPortFeature(IFeatureProvider fp) {
		super(fp, "FaultInPort", "Create Function Power Port");
	}
	...
	public Object[] create(ICreateContext context) {
        ...
        FaultInPort newQualReq = Eastadl21Factory.eINSTANCE.createFaultInPort();
