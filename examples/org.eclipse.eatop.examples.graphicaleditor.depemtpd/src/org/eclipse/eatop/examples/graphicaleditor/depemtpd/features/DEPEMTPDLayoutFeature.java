...
public class DEPEMTPDLayoutFeature extends AbstractLayoutFeature {
	...
	public DEPEMTPDLayoutFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.get(0) instanceof ErrorModelType||
				businessObjects.get(0) instanceof FunctionType||
				businessObjects.get(0) instanceof HardwareComponentType;
	}
