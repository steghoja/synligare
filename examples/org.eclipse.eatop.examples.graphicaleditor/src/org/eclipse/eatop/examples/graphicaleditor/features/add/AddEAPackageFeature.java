 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.features.add;
...
public class AddEAPackageFeature extends AbstractAddShapeFeature {
	...
	public AddEAPackageFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
...

		{
			...
			if (addedEAPackage.eResource() == null) {
				getDiagram().eResource().getContents().add(addedEAPackage);
			}
...

		{
			Shape shape = (Shape) peCreateService.createShape(containerShape,
					false);
			Text text1 = gaService.createText(shape, addedEAPackage.eClass()
					.getName());
