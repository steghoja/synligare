...
public class EAPPropertySection extends GFPropertySection implements
		ITabbedPropertyConstants {

	private Text nameText;

	public EAPPropertySection() {
	}
	...
	public void refresh() {
		...
		if (pe != null) {
			...
			if (bo == null)
				return;
			String shortname = ((EAPackage) bo).getShortName();
