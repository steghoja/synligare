...
public class VLDUpdateFeature extends AbstractUpdateFeature {

	public VLDUpdateFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canUpdate(IUpdateContext context) {
		...
		Object bo = getBusinessObjectForPictogramElement(context
				.getPictogramElement());
		return (bo instanceof EAElement);
	}
	...
	public IReason updateNeeded(IUpdateContext context) {
		...
		if (bo instanceof EAElement) {
			EAElement fm = (EAElement) bo;
			businessName1 = fm.getShortName();
		}
