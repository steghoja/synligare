 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.vlfd.graphiti.features;
...
public class VLDLayoutFeature extends AbstractLayoutFeature {
	private static final int MIN_HEIGHT = 50;

	private static final int MIN_WIDTH = 80;

	public VLDLayoutFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.size() == 1
				...
				|| businessObjects.get(0) instanceof FeatureModel
				|| businessObjects.get(0) instanceof FeatureConstraint;
