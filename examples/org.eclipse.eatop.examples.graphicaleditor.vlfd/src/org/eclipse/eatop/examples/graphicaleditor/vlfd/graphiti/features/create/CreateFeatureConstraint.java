...
public class CreateFeatureConstraint extends AbstractCreateFeature {
	private static final String TITLE = "Create Feature Constraint";

	private static final String USER_QUESTION = "Enter new Feature Constraint name";

	public CreateFeatureConstraint(IFeatureProvider fp) {
		super(fp, "FeatureConstraint", "Create  Feature Constraint");
	}

	@Override
	public String getCreateImageId() {
		return VLDImageProvider.IMAGE_FeatureConstraint;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		FeatureConstraint newQualReq = Eastadl21Factory.eINSTANCE
		...
		EReference referenceId = Eastadl21Factory.eINSTANCE.getEastadl21Package().getFeatureModel_FeatureConstraint();
