...
public class AddFeatureLink extends AbstractAddFeature {
	private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(
			98, 131, 167);

	public AddFeatureLink(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		/* && context.getNewObject() instanceof FeatureLink */) {
			return true;
		}
		return false;
	}
	...
	public PictogramElement add(IAddContext context) {
		...
		FeatureLink eReference = (FeatureLink) context.getNewObject();
		text.setValue(eReference.getShortName());
