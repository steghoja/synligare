...
public class AddQuantitativeSafetyConstraintToFaultFailureFeature extends AbstractAddFeature {
	 private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(98, 131, 167);
	public AddQuantitativeSafetyConstraintToFaultFailureFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
        ...
        text.setValue("+constrainedFaultFailure");
