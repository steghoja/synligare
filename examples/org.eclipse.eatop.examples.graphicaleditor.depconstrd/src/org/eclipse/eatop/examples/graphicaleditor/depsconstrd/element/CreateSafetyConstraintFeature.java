...
public class CreateSafetyConstraintFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create SafetyConstraint";
	private static final String USER_QUESTION = "Enter new SafetyConstraint short name";
	public CreateSafetyConstraintFeature(IFeatureProvider fp) {
		super(fp, "SafetyConstraint", "Create SafetyConstraint");
	}
	...
	public Object[] create(ICreateContext context) {
		...
		SafetyConstraint newMT = Eastadl21Factory.eINSTANCE.createSafetyConstraint();
		...
		EReference referenceId = Eastadl21Factory.eINSTANCE.getEastadl21Package().getDependability_SafetyConstraint();
	...
	public String getCreateImageId() {
		return DEPSConstrDImageProvider.SAFETYCONSTRAINT;
	}
