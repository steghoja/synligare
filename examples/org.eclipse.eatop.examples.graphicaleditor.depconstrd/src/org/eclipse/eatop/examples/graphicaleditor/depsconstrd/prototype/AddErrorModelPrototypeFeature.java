 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.depsconstrd.prototype;
...
public class AddErrorModelPrototypeFeature extends
		AbstractAddShapeFeature {
	private static final IColorConstant ErrorModelPrototype_TEXT_FOREGROUND = IColorConstant.BLACK;
	...
	public AddErrorModelPrototypeFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		ErrorModelPrototype componentTypeToAdd = (ErrorModelPrototype) context
				.getNewObject();
		...
		if(componentTypeToAdd.getType() != null) {
			EList<FaultInPort> fips = componentTypeToAdd.getType().getExternalFault();
			EList<FailureOutPort> fops = componentTypeToAdd.getType().getFailure();
			
			for (FaultInPort fp : fips) {
