...
public class AddFaultFailureFeature extends AbstractAddShapeFeature {
	...
	public AddFaultFailureFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof FaultFailure) {
	...
	public PictogramElement add(IAddContext context) {
		FaultFailure addedClaim = (FaultFailure) context.getNewObject();
