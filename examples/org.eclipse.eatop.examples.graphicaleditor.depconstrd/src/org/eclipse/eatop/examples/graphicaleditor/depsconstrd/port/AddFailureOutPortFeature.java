 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.depsconstrd.port;
...
private PictogramElement createBoundPort(final ContainerShape container, final int xpos, final int ypos , IAddContext context) {
		...
		
		{
			...
			final Text text = gaService.createPlainText(shape, direction +" : "+ FailureOutPort.getShortName());
