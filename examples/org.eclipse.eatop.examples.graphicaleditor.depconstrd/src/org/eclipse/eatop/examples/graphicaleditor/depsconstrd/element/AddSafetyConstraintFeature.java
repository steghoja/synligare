...
public class AddSafetyConstraintFeature extends AbstractAddShapeFeature {
	...
	public AddSafetyConstraintFeature(IFeatureProvider fp) {
	...
	public PictogramElement add(IAddContext context) {
		SafetyConstraint addedClaim = (SafetyConstraint) context.getNewObject();
