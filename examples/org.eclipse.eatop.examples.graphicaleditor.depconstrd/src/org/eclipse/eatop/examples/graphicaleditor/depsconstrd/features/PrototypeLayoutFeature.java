...
public class PrototypeLayoutFeature extends AbstractLayoutFeature {
	...
	public static final int MIN_CONTAINER_WIDTH = MIN_WIDTH + AddFaultInPortFeature.PORT_SIZE;
	/** minimal height for the port container shapes. */
	public static final int MIN_CONTAINER_HEIGHT = MIN_HEIGHT + AddFaultInPortFeature.PORT_SIZE;

	public PrototypeLayoutFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean layout(final ILayoutContext context) {
		...
		int containerWidth = containerGa.getWidth() - AddFaultInPortFeature.PORT_SIZE;
		int containerHeight = containerGa.getHeight() - AddFaultInPortFeature.PORT_SIZE;
		...
		for (Shape shape : containerShape.getChildren()) {
			...
			if (containerWidth != size.getWidth()) {
				...
				if (graphicsAlgorithm instanceof Polyline) {
					...
					Point newSecondPoint = gaService.createPoint(containerWidth + AddFaultInPortFeature.PORT_SIZE / 2, secondPoint.getY());
		...
		for (GraphicsAlgorithm child : containerGa.getGraphicsAlgorithmChildren()) {
			gaService.setLocationAndSize(child, AddFaultInPortFeature.PORT_SIZE / 2, AddFaultInPortFeature.PORT_SIZE / 2, containerWidth, containerHeight);
			anythingChanged = true;
		}
