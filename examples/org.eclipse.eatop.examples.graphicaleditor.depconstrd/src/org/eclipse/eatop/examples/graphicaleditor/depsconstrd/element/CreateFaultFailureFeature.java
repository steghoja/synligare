...
public class CreateFaultFailureFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create FaultFailure";
	private static final String USER_QUESTION = "Enter new FaultFailure short name";
	public CreateFaultFailureFeature(IFeatureProvider fp) {
		super(fp, "FaultFailure", "Create FaultFailure");
	}
	...
	public Object[] create(ICreateContext context) {
		...
		FaultFailure newMT = Eastadl21Factory.eINSTANCE.createFaultFailure();
		...
		EReference referenceId = Eastadl21Factory.eINSTANCE.getEastadl21Package().getDependability_FaultFailure();
	...
	public String getCreateImageId() {
		return DEPSConstrDImageProvider.FAULTFAILURE;
	}
