...
public class AddDependabilityErrorModelTypePackageFeature extends
	...
	public AddDependabilityErrorModelTypePackageFeature(IFeatureProvider fp) 
	{
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
...

		{
			...
			if (((EObject) addedBusinessObject).eResource() == null) 
			{
				getDiagram().eResource().getContents().add((EObject) addedBusinessObject);
			}
