...
public class CreateAnalysisTypePackageFeature extends AbstractCreateFeature {
	public static String CREATE_CLASS_NAME = "AnalysisTypePackage"; 
	public static String CREATE_CLASS_DESCRIPTION = "Create AnalysisTypePackage"; 
	public static final String TITLE = "Create AnalysisTypePackage"; 
