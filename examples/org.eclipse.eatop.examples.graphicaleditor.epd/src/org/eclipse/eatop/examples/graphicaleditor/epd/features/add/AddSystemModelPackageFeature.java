...
public class AddSystemModelPackageFeature extends AbstractAddShapeFeature {
	...
	public AddSystemModelPackageFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		EAPackage addedBusinessObject = (EAPackage) context.getNewObject();
