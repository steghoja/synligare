...
public class CreateDependabilityErrorModelTypePackageFeature extends
		AbstractCreateFeature {
	public static String CREATE_CLASS_NAME = "DependabilityErrorModelTypePackage"; //$NON-NLS-1$
	public static String CREATE_CLASS_DESCRIPTION = "Create DependabilityErrorModelTypePackage"; //$NON-NLS-1$
	...
	public CreateDependabilityErrorModelTypePackageFeature(IFeatureProvider fp) {
	...
	public Object[] create(ICreateContext context) {
		...
		newDependability.setName("DependabilityErrorModelTypePackage");
