...
public class CreateDesignTypePackageFeature extends AbstractCreateFeature {
	public static String CREATE_CLASS_NAME = "DesignTypePackage"; 
	public static String CREATE_CLASS_DESCRIPTION = "Create DesignTypePackage"; 
	public static final String TITLE = "Create DesignTypePackage"; 
