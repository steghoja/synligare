...
public class OpenDEPDDiagramFeature extends AbstractDrillDownFeature {

	private IPeService peService;
	private Collection<Diagram> diagrams;

	public OpenDEPDDiagramFeature(IFeatureProvider fp) {
		super(fp);
	...
	public void execute(ICustomContext context) {
		...
		if (elements.length == 1) {
			...
			if (linkedDiagrams.size() == 0) {
				...
				Diagram diagram = peService.createDiagram("org.eclipse.eatop.examples.graphicaleditor.depd", "DependabilityVehicleLevel diagram", true);
