...
public class AddDependabilitySafetyConstraintsFeature extends AbstractAddShapeFeature {
	...
	public AddDependabilitySafetyConstraintsFeature(IFeatureProvider fp) {
		super(fp);
	}
