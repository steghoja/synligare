...
public class AddRequirementModelFeature extends AbstractAddShapeFeature {
	...
	public AddRequirementModelFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		RequirementsModel addedBusinessObject = (RequirementsModel) context.getNewObject();
		...
		{
			Shape shape = (Shape) peCreateService.createShape(containerShape, false);
			Text text1 = gaService.createText(shape, addedBusinessObject.eClass() .getName());
