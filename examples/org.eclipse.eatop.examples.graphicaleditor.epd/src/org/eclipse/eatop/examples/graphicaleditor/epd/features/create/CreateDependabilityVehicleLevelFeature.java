...
public class CreateDependabilityVehicleLevelFeature extends AbstractCreateFeature {
	public static String CREATE_CONNECTION_NAME = "DependabilityVehicleLevel"; //$NON-NLS-1$
	public static String CREATE_CONNECTION_DESCRIPTION = "Create DependabilityVehicleLevel"; //$NON-NLS-1$
	...
	public CreateDependabilityVehicleLevelFeature(IFeatureProvider fp) {
	...
	public Object[] create(ICreateContext context) {
		...
		newDependability.setName("DependabilityVehicleLevel");
