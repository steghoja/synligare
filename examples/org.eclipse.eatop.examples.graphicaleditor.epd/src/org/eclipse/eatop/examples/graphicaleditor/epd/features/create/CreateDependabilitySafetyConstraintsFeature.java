...
public class CreateDependabilitySafetyConstraintsFeature extends
		AbstractCreateFeature {
	public static String CREATE_CLASS_NAME = "DependabilitySafetyConstraints"; //$NON-NLS-1$
	public static String CREATE_CLASS_DESCRIPTION = "Create DependabilitySafetyConstraints"; //$NON-NLS-1$
	...
	public CreateDependabilitySafetyConstraintsFeature(IFeatureProvider fp) {
	...
	public Object[] create(ICreateContext context) {
		...
		newDependability.setName("DependabilitySafetyConstraints");
