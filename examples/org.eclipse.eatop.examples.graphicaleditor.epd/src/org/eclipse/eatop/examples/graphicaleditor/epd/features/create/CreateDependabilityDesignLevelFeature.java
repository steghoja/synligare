...
public class CreateDependabilityDesignLevelFeature extends
		AbstractCreateFeature {
	public static String CREATE_CLASS_NAME = "DependabilityDesignLevel"; 
	public static String CREATE_CLASS_DESCRIPTION = "Create DependabilityDesignLevel"; 
	public static final String TITLE = "Create Dependability"; 
	public static final String USER_QUESTION = "Enter name"; 
	public CreateDependabilityDesignLevelFeature(IFeatureProvider fp) {
	...
	public Object[] create(ICreateContext context) {
		...
		Dependability newDesignLevel = Eastadl21Factory.eINSTANCE.createDependability();
		newDesignLevel.setName("DependabilityDesignLevel");
