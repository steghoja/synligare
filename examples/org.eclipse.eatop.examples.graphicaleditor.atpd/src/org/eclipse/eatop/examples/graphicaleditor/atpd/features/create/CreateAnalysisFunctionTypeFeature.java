...
public class CreateAnalysisFunctionTypeFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Analysis Function Type";
	 
	   private static final String USER_QUESTION = "Enter new Analysis Function Type name";
	   
	public CreateAnalysisFunctionTypeFeature(IFeatureProvider fp) {
		super(fp, "AnalysisFunctionType", "Create Analysis Function Type");
	}

	@Override
	public String getCreateImageId() {
		return ATPDImageProvider.IMAGE_AnalysisFunctionType;
	}
	...
	public Object[] create(ICreateContext context) {
        ...
        AnalysisFunctionType newQualReq = Eastadl21Factory.eINSTANCE.createAnalysisFunctionType();
