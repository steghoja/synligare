...
public class AddAnalysisFunctionTypeFeature extends AbstractAddShapeFeature {
	...
	public AddAnalysisFunctionTypeFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		// check if user wants to add a AnalysisFunctionType
	...
	public PictogramElement add(IAddContext context) {
		AnalysisFunctionType componentTypeToAdd = (AnalysisFunctionType) context.getNewObject();
