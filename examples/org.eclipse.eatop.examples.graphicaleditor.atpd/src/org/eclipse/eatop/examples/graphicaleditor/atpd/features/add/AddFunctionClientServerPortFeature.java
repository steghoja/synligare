...
public class AddFunctionClientServerPortFeature extends AbstractAddShapeFeature {
	...
	public static final int PORT_SIZE = 10;private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(98, 131, 167);
				...
				for (Shape s : parentC.getChildren())
					for (Anchor cs : s.getAnchors()) {
						if (getBusinessObjectForPictogramElement(cs) instanceof FunctionPort) {
							if (getBusinessObjectForPictogramElement(cs)
