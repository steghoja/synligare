...
public class AddFunctionOutFlowPortFeature extends AbstractAddShapeFeature {
	...
	public AddFunctionOutFlowPortFeature(IFeatureProvider fp) {
	...
	public PictogramElement add(IAddContext context) {
		final FunctionFlowPort addedQualReq = (FunctionFlowPort) context
				.getNewObject();
		...
		// SHAPE WITH TEXT for FunctionFlowPortType
		{
       	 // create shape for text  
