...
public class AddHardwareFunctionTypeFeature extends AbstractAddShapeFeature {
	...
	public AddHardwareFunctionTypeFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		// check if user wants to add a DesignFunctionType
		if (context.getNewObject() instanceof HardwareFunctionType) {
	...
	public PictogramElement add(IAddContext context) {
		HardwareFunctionType componentTypeToAdd = (HardwareFunctionType) context.getNewObject();
