...
public class AddLocalDeviceManagerFeature extends AbstractAddShapeFeature {
	...
	public AddLocalDeviceManagerFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof LocalDeviceManager) {
	...
	public PictogramElement add(IAddContext context) {
		LocalDeviceManager componentTypeToAdd = (LocalDeviceManager) context.getNewObject();
