...
public class CreateHardwareFunctionTypeTypeFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Hardware Function Type";
	 
	   private static final String USER_QUESTION = "Enter new Hardware Function Type name";
	   
	public CreateHardwareFunctionTypeTypeFeature(IFeatureProvider fp) {
		super(fp, "HardwareFunctionType", "Create Hardware Function Type");
	}

	@Override
	public String getCreateImageId() {
		return DTPDDImageProvider.IMAGE_HardwareFunctionTypee;
	}
	...
	public Object[] create(ICreateContext context) {
        ...
        HardwareFunctionType newQualReq = Eastadl21Factory.eINSTANCE.createHardwareFunctionType();
