...
public class CreateDesignFunctionTypeFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Design Function Type";
	 
	   private static final String USER_QUESTION = "Enter new Design Function Type name";
	   
	public CreateDesignFunctionTypeFeature(IFeatureProvider fp) {
		super(fp, "DesignFunctionType", "Create Design Function Type");
	}

	@Override
	public String getCreateImageId() {
		return DTPDDImageProvider.IMAGE_DesignFunctionType;
	}
	...
	public Object[] create(ICreateContext context) {
        ...
        DesignFunctionType newQualReq = Eastadl21Factory.eINSTANCE.createDesignFunctionType();
