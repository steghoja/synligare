...
public class AddBasicSoftwareFunctionTypeFeature extends AbstractAddShapeFeature {
	...
	public AddBasicSoftwareFunctionTypeFeature(IFeatureProvider fp) {
	...
	public PictogramElement add(IAddContext context) {
		BasicSoftwareFunctionType componentTypeToAdd = (BasicSoftwareFunctionType) context.getNewObject();
