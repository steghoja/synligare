...
public class CreateLocalDeviceManagerFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Basic Software Type";
	 
	   private static final String USER_QUESTION = "Enter new Local Device Manager name";
	   
	public CreateLocalDeviceManagerFeature(IFeatureProvider fp) {
		super(fp, "LocalDeviceManager", "Create Local Device Manager");
	}

	@Override
	public String getCreateImageId() {
		return DTPDDImageProvider.IMAGE_LocalDeviceManager;
	}
	...
	public Object[] create(ICreateContext context) {
        ...
        LocalDeviceManager newQualReq = Eastadl21Factory.eINSTANCE.createLocalDeviceManager();
