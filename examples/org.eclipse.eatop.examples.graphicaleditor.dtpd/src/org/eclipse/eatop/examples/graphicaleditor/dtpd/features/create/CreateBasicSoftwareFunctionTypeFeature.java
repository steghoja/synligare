...
public class CreateBasicSoftwareFunctionTypeFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Basic Software Type";
	 
	   private static final String USER_QUESTION = "Enter new Basic Software Type name";
	   
	public CreateBasicSoftwareFunctionTypeFeature(IFeatureProvider fp) {
		super(fp, "BasicSoftwareType", "Create Basic Software Type");
	}

	@Override
	public String getCreateImageId() {
		return DTPDDImageProvider.IMAGE_BasicSoftwareType;
	}
	...
	public Object[] create(ICreateContext context) {
        ...
        BasicSoftwareFunctionType newQualReq = Eastadl21Factory.eINSTANCE.createBasicSoftwareFunctionType();
