...
public class CreateFunctionPowerPortFeature extends AbstractCreateFeature {
	...
	public String getCreateImageId() {
		return DTPDDImageProvider.IMAGE_FunctionPowerPort;
	}
	...
	public boolean canCreate(ICreateContext context) {
    	...
    	if(bo.get(0) instanceof HardwareFunctionType)
    	{
    		return true;
    	}
    	return false;
	...
	public Object[] create(ICreateContext context) {
        ...
        FunctionPowerPort newQualReq = Eastadl21Factory.eINSTANCE.createFunctionPowerPort();
