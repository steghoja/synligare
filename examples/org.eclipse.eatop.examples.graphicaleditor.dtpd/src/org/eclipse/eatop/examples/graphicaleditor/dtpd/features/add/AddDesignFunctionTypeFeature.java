...
public class AddDesignFunctionTypeFeature extends AbstractAddShapeFeature {
	...
	public AddDesignFunctionTypeFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof DesignFunctionType) {
	...
	public PictogramElement add(IAddContext context) {
		DesignFunctionType componentTypeToAdd = (DesignFunctionType) context.getNewObject();
