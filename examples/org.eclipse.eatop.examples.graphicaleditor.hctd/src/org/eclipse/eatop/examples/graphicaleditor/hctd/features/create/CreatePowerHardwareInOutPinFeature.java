...
public class CreatePowerHardwareInOutPinFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Power Hardware InOut Pin";
	 
	   private static final String USER_QUESTION = "Enter new Power Hardware Pin name";
	   
	public CreatePowerHardwareInOutPinFeature(IFeatureProvider fp) {
		super(fp, "PowerHardwareInOutPin", "Create Power Hardware InOut Pin");
	}

	@Override
	public String getCreateImageId() {
		return HCTDImageProvider.IMAGE_PowerHardwarePin;
	}
	...
	public Object[] create(ICreateContext context) {
        ...
        PowerHardwarePin newQualReq = Eastadl21Factory.eINSTANCE.createPowerHardwarePin();
