...
public class CreatePowerHardwareInPinFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create PowerHard ware In Pin";

	private static final String USER_QUESTION = "Enter new Power Hardware Pin name";

	public CreatePowerHardwareInPinFeature(IFeatureProvider fp) {
		super(fp, "PowerHardwareInPin", "Create Power Hardware In Pin");
	}
