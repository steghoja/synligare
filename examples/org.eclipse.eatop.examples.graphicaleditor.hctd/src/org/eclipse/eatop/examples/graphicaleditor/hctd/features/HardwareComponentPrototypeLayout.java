...
public class HardwareComponentPrototypeLayout extends AbstractLayoutFeature {
	...
	public HardwareComponentPrototypeLayout(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.get(0) instanceof HardwareComponentPrototype;
	}
