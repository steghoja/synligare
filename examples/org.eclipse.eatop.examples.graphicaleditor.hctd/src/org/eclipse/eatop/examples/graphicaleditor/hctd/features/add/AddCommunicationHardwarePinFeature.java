 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.hctd.features.add;
...
public class AddCommunicationHardwarePinFeature extends AbstractAddShapeFeature {
	...
	public boolean canAdd(IAddContext context) {
		// check if user wants to add a communicationHardwarePin
	...
	private PictogramElement createBoundPort(final ContainerShape container,
		...
		CommunicationHardwarePin communicationHardwarePin = (CommunicationHardwarePin) context
				.getNewObject();
		IGaService gaService = Graphiti.getGaService();
		if (communicationHardwarePin.getDirection() == EADirectionKind.IN) {
			direction = "CHP : I";
		}
		if (communicationHardwarePin.getDirection() == EADirectionKind.OUT) {
			direction = "CHP : O";
		}
		if (communicationHardwarePin.getDirection() == EADirectionKind.INOUT) {
			direction = "CHP : IO";
		}

		{
			...
			final Text text = gaService.createPlainText(shape, direction
					+ " : " + communicationHardwarePin.getShortName());
