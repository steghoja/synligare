...
public class AddHardwareComponentPrototypeFeature extends
	...
	private static final IColorConstant hardwareComponentPrototype_TEXT_FOREGROUND = IColorConstant.BLACK;
	...
	public PictogramElement add(IAddContext context) {
		...
		// SHAPE WITH TEXT for EAPackageType
		{
			...
			Text text1 = gaService.createText(shape, componentTypeToAdd
					.eClass().getName());
			text1.setForeground(manageColor(hardwareComponentPrototype_TEXT_FOREGROUND));
