...
public class HCTDPropertySection extends GFPropertySection implements
		ITabbedPropertyConstants {
	private Text nameText;

	public HCTDPropertySection() {
	}
	...
	public void refresh() {
		...
		if (pe != null) {
			...
			} else if (bo instanceof HardwarePin) {
				shortname = ((HardwarePin) bo).getShortName();
			}
			...
			nameText.addModifyListener(new ModifyListener() {
				...
				public void modifyText(ModifyEvent e) {
					...
					if (pe != null) {
						...
						String shortname = null;
						if (bo instanceof HardwareComponentPrototype) {
							shortname = ((HardwareComponentPrototype) bo)
									.getShortName();
						} else if (bo instanceof HardwarePin) {
							shortname = ((HardwarePin) bo).getShortName();
						}
						...
						public void execute(IContext context) {
							...
							if (pe != null) {
								...
								if (bo instanceof HardwareComponentPrototype) {
									...
									HardwarePin eClass = (HardwarePin) bo;
									eClass.setShortName(typedValue);
								}
							}
						}
