...
public class AddTSCToRequirementFeature extends AbstractAddFeature{
	public AddTSCToRequirementFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		...
		text.setValue("+technicalSafetyRequirement");
