...
public class AddSatisfytoDesignFunctionPrototypeFeature extends AbstractAddFeature{
	public AddSatisfytoDesignFunctionPrototypeFeature(IFeatureProvider fp) {
		super(fp);
	}
