...
public class AddTechnicalSafetyConceptFeature extends AbstractAddShapeFeature {
	...
	public AddTechnicalSafetyConceptFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context.getNewObject() instanceof TechnicalSafetyConcept) {
	...
	public PictogramElement add(IAddContext context) {
		TechnicalSafetyConcept addedTSC = (TechnicalSafetyConcept) context.getNewObject();
	      ...
	      final  ContainerShape containerShape =
	       ...
	       final IGaService gaService = Graphiti.getGaService();
	 ...
	 
	        {
	            ...
	            if (((EObject) addedTSC).eResource() == null) {
	                     getDiagram().eResource().getContents().add((EObject) addedTSC);
	            }
	            // create link and wire it
	            link(containerShape, addedTSC);
	        }
	        ...
	        // SHAPE WITH TEXT for ShortName
	        {
	            ...
	            Text text = gaService.createText(shape, addedTSC.getShortName());
	     ...
	     // SHAPE WITH TEXT for HazardType
	        {
	            ...
	            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
	        	//add Text 
	             Text text1=gaService.createText(shape, ((EObject) addedTSC).eClass().getName());
