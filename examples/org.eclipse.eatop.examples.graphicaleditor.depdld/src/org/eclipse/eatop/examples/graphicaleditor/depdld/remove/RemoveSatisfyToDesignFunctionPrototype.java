 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.depdld.remove;
...
public class RemoveSatisfyToDesignFunctionPrototype extends
		DefaultRemoveFeature {

	public RemoveSatisfyToDesignFunctionPrototype(IFeatureProvider fp) {
		super(fp);
	}
	...
	public void preRemove(IRemoveContext context) {
		...
		Assert.isTrue(getBusinessObjectForPictogramElement(element.getEnd()
				.getParent()) instanceof DesignFunctionPrototype,
				"The start element isn't a DesignFunctionPrototype!");
		DesignFunctionPrototype target = (DesignFunctionPrototype) getBusinessObjectForPictogramElement(element
				.getEnd().getParent());
