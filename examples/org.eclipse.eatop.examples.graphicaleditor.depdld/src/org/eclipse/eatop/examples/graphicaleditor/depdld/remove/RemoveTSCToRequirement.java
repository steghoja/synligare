...
public class RemoveTSCToRequirement extends DefaultRemoveFeature {

	public RemoveTSCToRequirement(IFeatureProvider fp) {
		super(fp);
	}
	@Override
	public void preRemove(IRemoveContext context) {
		...
		Assert.isTrue(getBusinessObjectForPictogramElement(element.getStart().getParent()) 
				instanceof TechnicalSafetyConcept, "The start element isn't a TechnicalSafetyConcept!");
		TechnicalSafetyConcept source = (TechnicalSafetyConcept) getBusinessObjectForPictogramElement(element.getStart().getParent());
