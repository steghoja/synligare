...
public class AddSatisfyFeature extends AbstractAddShapeFeature {

	public AddSatisfyFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
     ...
     if (context.getNewObject() instanceof Satisfy) {
	...
	public PictogramElement add(IAddContext context) {
		Satisfy addedSatisfy = (Satisfy) context.getNewObject();
   ...
   final  ContainerShape containerShape =
    ...
    final IGaService gaService = Graphiti.getGaService();
...

     {
         ...
         if (((EObject) addedSatisfy).eResource() == null) {
                  getDiagram().eResource().getContents().add((EObject) addedSatisfy);
         }
         // create link and wire it
         link(containerShape, addedSatisfy);
     }
     ...
     // SHAPE WITH TEXT for ShortName
     {
         ...
         Text text = gaService.createText(shape, addedSatisfy.getShortName());
  ...
  // SHAPE WITH TEXT for HazardType
     {
         ...
         Shape shape = (Shape) peCreateService.createShape(containerShape, false);
     	//add Text 
          Text text1=gaService.createText(shape, ((EObject) addedSatisfy).eClass().getName());
