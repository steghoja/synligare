...
public class DesignFunctionProtoTypeLayout extends AbstractLayoutFeature {
	...
	public DesignFunctionProtoTypeLayout(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return businessObjects.get(0) instanceof DesignFunctionPrototype;
	}
