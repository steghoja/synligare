...
public class RemoveClaimToQualityRequirementFeature extends
		DefaultRemoveFeature {

	public RemoveClaimToQualityRequirementFeature(IFeatureProvider fp) {
		super(fp);
	}
	@Override
	...
	public void preRemove(IRemoveContext context) {
		...
		Assert.isTrue(getBusinessObjectForPictogramElement(element.getEnd().getParent()) instanceof QualityRequirement, "The start element isn't a QualityRequirement!");
		QualityRequirement target = (QualityRequirement) getBusinessObjectForPictogramElement(element.getEnd().getParent());
