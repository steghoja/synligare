...
public class CreateClaimToGroundFeature extends AbstractCreateConnectionFeature {

	public CreateClaimToGroundFeature(IFeatureProvider fp) {
		super(fp, "Claim To Ground", "Create Claim To Ground");
	}
	...
	public Connection create(ICreateConnectionContext context) {
        ...
        if (claim != null && ground != null) {
        	EReference referenceId = Eastadl21Factory.eINSTANCE.getEastadl21Package().getClaim_Evidence();
        	DiagramUtil.addReferenceToBOResource(claim, referenceId, ground);
