...
public class RemoveWarrantToClaimFeature extends DefaultRemoveFeature {

	public RemoveWarrantToClaimFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public void preRemove(IRemoveContext context) {
		...
		Assert.isTrue(getBusinessObjectForPictogramElement(element.getEnd().getParent()) instanceof Claim, "The start element isn't a Claim!");
		Claim target = (Claim) getBusinessObjectForPictogramElement(element.getEnd().getParent());
