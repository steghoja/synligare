 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.depscd.features.property;
...
public class DEPSCDPropertySection extends GFPropertySection implements
		ITabbedPropertyConstants {
	 private Text nameText;
	public DEPSCDPropertySection() {
	}
	...
	public void refresh() {
        ...
        if (pe != null) {
            ...
            if (bo == null)
                return;
            String shortname = ((TraceableSpecification) bo).getShortName();
