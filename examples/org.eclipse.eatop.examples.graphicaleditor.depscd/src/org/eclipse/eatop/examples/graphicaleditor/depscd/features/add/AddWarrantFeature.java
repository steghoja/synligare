...
public class AddWarrantFeature extends AbstractAddShapeFeature {
	...
	public AddWarrantFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		Warrant addedWarrant = (Warrant) context.getNewObject();
      ...
      final  ContainerShape containerShape =
       ...
       final IGaService gaService = Graphiti.getGaService();
 ...
 
        {
            ...
            if (addedWarrant.eResource() == null) {
                     getDiagram().eResource().getContents().add(addedWarrant);
            }
            // create link and wire it
            link(containerShape, addedWarrant);
        }
        ...
        // SHAPE WITH TEXT for ShortName
        {
            ...
            Text text = gaService.createText(shape, addedWarrant.getShortName());
     ...
     // SHAPE WITH TEXT for ItemType
        {
            ...
            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
        	//add Text 
             Text text1=gaService.createText(shape, addedWarrant.eClass().getName());
