...
public class CreateGoalDecompositionStrategy extends
		AbstractCreateConnectionFeature {
	public static int lock = 0;
	public CreateGoalDecompositionStrategy(IFeatureProvider fp) {
		super(fp, "Claim To WarrantGoalDecompositionStrategy", "Create GoalDecompositionStrategy");
	}
	...
	public Connection create(ICreateConnectionContext context) {
        ...
        if (claim != null && warrant != null) {
        	EReference referenceId = Eastadl21Factory.eINSTANCE.getEastadl21Package().getClaim_GoalDecompositionStrategy();
