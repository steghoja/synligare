...
public class EDUpdateFeature extends AbstractUpdateFeature {

	public EDUpdateFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public IReason updateNeeded(IUpdateContext context) {
        ...
        if (bo instanceof FunctionPrototype) {
        	FunctionPrototype proto = (FunctionPrototype) bo;
            businessName = proto.getShortName();
        }
        if (bo instanceof FunctionPort) {
        	FunctionPort port = (FunctionPort) bo;
            businessName = port.getShortName();
        }
	...
	public boolean update(IUpdateContext context) {
        ...
        if (bo instanceof FunctionType) {
        	FunctionType req = (FunctionType) bo;
