...
import org.eclipse.eatop.examples.graphicaleditor.ed.provider.EDImageProvider;
...
public class CreateEnvironmentFeature extends AbstractCreateFeature {
	...
	public CreateEnvironmentFeature(IFeatureProvider fp) {
		super(fp, "Environment", "Create Anlaysis Type Package");
	}

	@Override
	public String getCreateImageId() {
		return EDImageProvider.ENVIRONMENT;
	}
	...
	public Object[] create(ICreateContext context) {
       ...
       Environment newQualReq = Eastadl21Factory.eINSTANCE.createEnvironment();
