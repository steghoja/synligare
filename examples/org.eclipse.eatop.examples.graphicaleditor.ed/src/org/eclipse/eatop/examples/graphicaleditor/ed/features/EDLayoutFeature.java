...
package org.eclipse.eatop.examples.graphicaleditor.ed.features;
...
public class EDLayoutFeature extends AbstractLayoutFeature {
	...
	public EDLayoutFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canLayout(ILayoutContext context) {
		...
		return  businessObjects.get(0) instanceof FunctionPrototype||
				businessObjects.get(0) instanceof FunctionPort||
				businessObjects.get(0) instanceof Environment;}
