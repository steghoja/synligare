...
public class AddEnvironmentFeature extends AbstractAddShapeFeature {
	...
	public AddEnvironmentFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context.getNewObject() instanceof Environment || context.getNewObject() instanceof FunctionType) {
	...
	public PictogramElement add(IAddContext context) {
		final Environment addedEnvi = (Environment) context.getNewObject();
...

		{
            ...
            if (addedEnvi.eResource() == null) {
                     getDiagram().eResource().getContents().add(addedEnvi);
            }
            // create link and wire it
            link(containerShape, addedEnvi);
        }
        // SHAPE WITH TEXT for ModeGroupType
        {
        	 // create shape for text  
            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
        	//add Text 
             Text text1=gaService.createText(shape, addedEnvi.eClass().getName());
        ...
        // SHAPE WITH TEXT for ShortName
        {
            ...
            Text text = gaService.createText(shape, addedEnvi.getShortName());
