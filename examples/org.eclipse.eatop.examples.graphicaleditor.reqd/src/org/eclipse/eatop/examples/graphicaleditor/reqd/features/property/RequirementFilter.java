...
public class RequirementFilter extends AbstractPropertySectionFilter {
	...
	protected boolean accept(PictogramElement pe) {
		 EObject eObject =
		        ...
		        if (eObject instanceof Requirement||eObject instanceof UseCase||
		        		eObject instanceof OperationalSituation ) {
		            return true;
		        }
		        return false;
