...
public class QualityRequirementUpdateFeature extends AbstractUpdateFeature {

	public QualityRequirementUpdateFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canUpdate(IUpdateContext context) {
        ...
        return (bo instanceof QualityRequirement);
	}
	...
	public IReason updateNeeded(IUpdateContext context) {
        ...
        if (bo instanceof TraceableSpecification) {
        	QualityRequirement req = (QualityRequirement) bo;
            businessName1 = req.getShortName();
            businessName2 = req.getText();
            businessName3=req.getKind().toString();
        }
