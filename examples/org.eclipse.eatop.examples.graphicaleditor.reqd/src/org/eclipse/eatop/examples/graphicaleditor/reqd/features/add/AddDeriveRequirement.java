...
public class AddDeriveRequirement extends AbstractAddFeature {
	private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(98, 131, 167);
	public AddDeriveRequirement(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context instanceof IAddConnectionContext
           /* && context.getNewObject() instanceof DeriveRequirement*/) {
            return true;
        }
        return false;
	}
	...
	public PictogramElement add(IAddContext context) {
		 IAddConnectionContext addConContext = (IAddConnectionContext) context;
	       // DeriveRequirement addedDeriveReq = (DeriveRequirement) context.getNewObject();
	     ...
	     // link(connection, derivRe);
	        ...
	        DeriveRequirement derivRe=(DeriveRequirement) context.getNewObject();
	        text.setValue(derivRe.getShortName());
