...
public class AddElectricalComponentFeature extends AbstractAddShapeFeature {
	...
	public AddElectricalComponentFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof ElectricalComponent) {
	...
	public PictogramElement add(IAddContext context) {
		ElectricalComponent componentTypeToAdd = (ElectricalComponent) context
				.getNewObject();
