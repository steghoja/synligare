...
public class CreateCommunicationHardwareInOutPinFeature extends
		AbstractCreateFeature {
	private static final String TITLE = "Create Communication Hardware InOut Pin";

	private static final String USER_QUESTION = "Enter new Communication Hardware Pin name";

	public CreateCommunicationHardwareInOutPinFeature(IFeatureProvider fp) {
		super(fp, "CommunicationHardwareInOutPin",
				"Create Communication Hardware InOut Pin");
	}

	@Override
	public String getCreateImageId() {
		return HCTPDImageProvider.IMAGE_CommunicationHardwarePin;
	}
