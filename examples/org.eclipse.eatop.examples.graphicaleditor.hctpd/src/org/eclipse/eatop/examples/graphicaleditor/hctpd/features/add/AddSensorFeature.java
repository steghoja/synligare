...
public class AddSensorFeature extends AbstractAddShapeFeature {
	...
	public AddSensorFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof Sensor) {
	...
	public PictogramElement add(IAddContext context) {
		Sensor componentTypeToAdd = (Sensor) context.getNewObject();
