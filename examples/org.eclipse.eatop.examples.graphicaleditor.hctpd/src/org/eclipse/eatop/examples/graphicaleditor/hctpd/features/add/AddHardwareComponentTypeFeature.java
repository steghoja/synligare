...
public class AddHardwareComponentTypeFeature extends AbstractAddShapeFeature {
	...
	public AddHardwareComponentTypeFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof HardwareComponentType) {
	...
	public PictogramElement add(IAddContext context) {
		HardwareComponentType componentTypeToAdd = (HardwareComponentType) context
				.getNewObject();
