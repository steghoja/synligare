...
import org.eclipse.eatop.examples.graphicaleditor.hctpd.features.OpenHCTDiagramFeature;
import org.eclipse.eatop.examples.graphicaleditor.hctpd.features.OpenHCTPDDiagramFeature;
...
public class HCTPDToolBehaviorProvider extends DefaultToolBehaviorProvider {

	public HCTPDToolBehaviorProvider(IDiagramTypeProvider diagramTypeProvider) {
	...
	public ICustomFeature getDoubleClickFeature(IDoubleClickContext context) {
		...
		ICustomFeature openAFTDDiagram = new OpenHCTDiagramFeature(getFeatureProvider());
		if (openAFTDDiagram.canExecute(context)) {
			return openAFTDDiagram;
		}
		ICustomFeature openATPDDiagram = new OpenHCTPDDiagramFeature(getFeatureProvider());
	...
	public IDecorator[] getDecorators(PictogramElement pe) {
		...
		if (bo instanceof FunctionalDevice) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_FunctionalDevice);
			return new IDecorator[] { imageRenderingDecorator };
		} else if (bo instanceof EAPackage) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_EAPackage);
			return new IDecorator[] { imageRenderingDecorator };
		} else if (bo instanceof HardwareComponentType) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_HardwareComponentType);
			return new IDecorator[] { imageRenderingDecorator };
		} else if (bo instanceof FunctionFlowPort) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_FunctionFlowPort);
			return new IDecorator[] { imageRenderingDecorator };
		} else if (bo instanceof FunctionClientServerPort) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_FunctionClientServerPort);
			return new IDecorator[] { imageRenderingDecorator };
		} else if (bo instanceof FunctionPowerPort) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_FunctionPowerPort);
			return new IDecorator[] { imageRenderingDecorator };
		}else if (bo instanceof Node) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_Node);
			return new IDecorator[] { imageRenderingDecorator };
		}else if (bo instanceof Sensor) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_Sensor);
			return new IDecorator[] { imageRenderingDecorator };
		}else if (bo instanceof ElectricalComponent) {
			IDecorator imageRenderingDecorator = new ImageDecorator(
					HCTPDImageProvider.IMAGE_ElectricalComponent);
			return new IDecorator[] { imageRenderingDecorator };
		}
