...
public class CreateHardwareComponentTypePackageFeature extends
	...
	public CreateHardwareComponentTypePackageFeature(IFeatureProvider fp) {
		super(fp, "HardwareComponentTypePackage",
				"Create Hardware Component Type Package");
	}

	@Override
	public String getCreateImageId() {
		return HCTPDImageProvider.IMAGE_EAPackage;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		EAPackage newQualReq = Eastadl21Factory.eINSTANCE.createEAPackage();
		newQualReq.setName("HardwareComponentTypePackage");
		newQualReq.setShortName(userAskedString);
