...
public class AddPowerHardwarePinFeature extends AbstractAddShapeFeature {
	public String direction;
	public static final int PORT_SIZE = 10;
	private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(
			98, 131, 167);

	public AddPowerHardwarePinFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof PowerHardwarePin) {
	...
	public PictogramElement add(IAddContext context) {
		PowerHardwarePin portToAdd = (PowerHardwarePin) context.getNewObject();
	...
	private PictogramElement createBoundPort(final ContainerShape container,
		...
		PowerHardwarePin functionFlowPort = (PowerHardwarePin) context
				.getNewObject();
