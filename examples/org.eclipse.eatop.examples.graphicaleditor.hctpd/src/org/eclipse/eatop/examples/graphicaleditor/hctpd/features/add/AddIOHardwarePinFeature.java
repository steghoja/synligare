...
public class AddIOHardwarePinFeature extends AbstractAddShapeFeature {
	public String direction;
	public static final int PORT_SIZE = 10;
	private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(
			98, 131, 167);

	public AddIOHardwarePinFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof IOHardwarePin) {
	...
	public PictogramElement add(IAddContext context) {
		IOHardwarePin portToAdd = (IOHardwarePin) context.getNewObject();
	...
	private PictogramElement createBoundPort(final ContainerShape container,
		...
		IOHardwarePin functionFlowPort = (IOHardwarePin) context.getNewObject();
