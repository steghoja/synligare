...
public class CreateActuatorFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Actuator";

	private static final String USER_QUESTION = "Enter new Actuator name";

	public CreateActuatorFeature(IFeatureProvider fp) {
		super(fp, "Actuator", "Create Actuator");
	}

	@Override
	public String getCreateImageId() {
		return HCTPDImageProvider.IMAGE_Actuator;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		Actuator newQualReq = Eastadl21Factory.eINSTANCE.createActuator();
