...
public class CreateFunctionalDeviceFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Functional Device ";

	private static final String USER_QUESTION = "Enter new Functional Device name";

	public CreateFunctionalDeviceFeature(IFeatureProvider fp) {
		super(fp, "FunctionalDevice ", "Create Functional Device ");
	}

	@Override
	public String getCreateImageId() {
		return HCTPDImageProvider.IMAGE_FunctionalDevice;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		FunctionalDevice newQualReq = Eastadl21Factory.eINSTANCE
				.createFunctionalDevice();
