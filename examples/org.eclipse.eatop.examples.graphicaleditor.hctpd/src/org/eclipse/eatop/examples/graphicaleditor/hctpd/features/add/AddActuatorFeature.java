...
public class AddActuatorFeature extends AbstractAddShapeFeature {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof Actuator) {
	...
	public PictogramElement add(IAddContext context) {
		Actuator componentTypeToAdd = (Actuator) context.getNewObject();
