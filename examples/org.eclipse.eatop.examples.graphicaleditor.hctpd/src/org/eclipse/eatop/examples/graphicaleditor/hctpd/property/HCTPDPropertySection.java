 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.hctpd.property;
...
public class HCTPDPropertySection extends GFPropertySection implements
		ITabbedPropertyConstants {
	private Text nameText;

	public HCTPDPropertySection() {
	}
	...
	public void refresh() {
		PictogramElement pe = getSelectedPictogramElement();
	       if (pe != null) {
	           ...
	           if (bo == null)
	               return;
	           String shortname = ((HardwareComponentType) bo).getShortName();
						...
						IFeature feature = new AbstractFeature(getDiagramTypeProvider().getFeatureProvider()) {
							...
							public void execute(IContext context) {
								...
								if (pe != null) {
									...
									if (bo == null)
										return;
									HardwareComponentType eClass = (HardwareComponentType) bo;
