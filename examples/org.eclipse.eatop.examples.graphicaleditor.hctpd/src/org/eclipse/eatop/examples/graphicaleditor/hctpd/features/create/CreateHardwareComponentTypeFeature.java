...
public class CreateHardwareComponentTypeFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Hardware Component Type";

	private static final String USER_QUESTION = "Enter new Hardware Component Type name";

	public CreateHardwareComponentTypeFeature(IFeatureProvider fp) {
		super(fp, "HardwareComponentType", "Create Hardware Component Type");
	}

	@Override
	public String getCreateImageId() {
		return HCTPDImageProvider.IMAGE_HardwareComponentType;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		HardwareComponentType newQualReq = Eastadl21Factory.eINSTANCE
