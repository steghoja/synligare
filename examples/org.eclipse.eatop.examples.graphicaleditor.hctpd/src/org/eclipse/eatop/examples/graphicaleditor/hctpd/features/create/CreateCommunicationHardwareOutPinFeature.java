...
public class CreateCommunicationHardwareOutPinFeature extends
		AbstractCreateFeature {
	private static final String TITLE = "Create Communication Hardware Out Pin";

	private static final String USER_QUESTION = "Enter new Communication Hardware Pin name";

	public CreateCommunicationHardwareOutPinFeature(IFeatureProvider fp) {
		super(fp, "CommunicationHardwareOutPin",
				"Create Communication Hardware Out Pin");
	}
