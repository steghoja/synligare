...
public class CreateElectricalComponentFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Electrical Component";

	private static final String USER_QUESTION = "Enter new Electrical Component name";

	public CreateElectricalComponentFeature(IFeatureProvider fp) {
		super(fp, "ElectricalComponent", "Create Electrical Component");
	}

	@Override
	public String getCreateImageId() {
		return HCTPDImageProvider.IMAGE_ElectricalComponent;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		ElectricalComponent newQualReq = Eastadl21Factory.eINSTANCE
				.createElectricalComponent();
