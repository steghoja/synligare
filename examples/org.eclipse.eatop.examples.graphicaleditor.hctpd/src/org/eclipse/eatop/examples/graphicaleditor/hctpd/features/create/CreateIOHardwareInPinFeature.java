...
public class CreateIOHardwareInPinFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Power IOHardware In Pin";

	private static final String USER_QUESTION = "Enter new IOHardware Pin name";

	public CreateIOHardwareInPinFeature(IFeatureProvider fp) {
		super(fp, "IOHardwareInPin", "Create IOHardware In Pin");
	}
