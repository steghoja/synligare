...
public class CreateIOHardwareInOutPinFeature extends AbstractCreateFeature {
	private static final String TITLE = "Create Power IOHardware InOut Pin";

	private static final String USER_QUESTION = "Enter new IOHardware Pin name";

	public CreateIOHardwareInOutPinFeature(IFeatureProvider fp) {
		super(fp, "IOHardwareInOutPin", "Create IOHardware InOut Pin");
	}

	@Override
	public String getCreateImageId() {
		return HCTPDImageProvider.IMAGE_IOHardwarePin;
	}
	...
	public Object[] create(ICreateContext context) {
		...
		IOHardwarePin newQualReq = Eastadl21Factory.eINSTANCE
				.createIOHardwarePin();
