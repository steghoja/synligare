...
public class AddSatisfytoRequirementFeature extends AbstractAddFeature{
	public AddSatisfytoRequirementFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		 IAddConnectionContext addConContext = (IAddConnectionContext) context;
	        ...
	        text.setValue("+satisfiedRequirement");
