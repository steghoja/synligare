...
public class AddFunctionalSafetyConceptFeature extends AbstractAddShapeFeature {
	...
	public AddFunctionalSafetyConceptFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
        ...
        if (context.getNewObject() instanceof FunctionalSafetyConcept) {
	...
	public PictogramElement add(IAddContext context) {
		FunctionalSafetyConcept addedFSC = (FunctionalSafetyConcept) context.getNewObject();
	      ...
	      final  ContainerShape containerShape =
	       ...
	       final IGaService gaService = Graphiti.getGaService();
	 ...
	 
	        {
	            ...
	            if (((EObject) addedFSC).eResource() == null) {
	                     getDiagram().eResource().getContents().add((EObject) addedFSC);
	            }
	     ...
	     // SHAPE WITH TEXT for HazardType
	        {
	            ...
	            Shape shape = (Shape) peCreateService.createShape(containerShape, false);
	        	//add Text 
	             Text text1=gaService.createText(shape, ((EObject) addedFSC).eClass().getName());
