...
public class AddFSCtoRequirementFeature extends AbstractAddFeature{
	public AddFSCtoRequirementFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
			...
			// note, that the context must be an instance of
	...
	public PictogramElement add(IAddContext context) {
		...
		text.setValue("+functionalSafetyRequirement");
