...
public class AddSatisfytoAnalysisFunctionPrototypeFeature extends AbstractAddFeature{
	public AddSatisfytoAnalysisFunctionPrototypeFeature(IFeatureProvider fp) {
		super(fp);
	}
