...
public class DFADUpdateFeature extends AbstractUpdateFeature {

	public DFADUpdateFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canUpdate(IUpdateContext context) {
        ...
        return (bo instanceof FunctionType || bo instanceof FunctionAllocation);
	}
	...
	public IReason updateNeeded(IUpdateContext context) {
        ...
        if (bo instanceof FunctionAllocation) {
        	FunctionAllocation ea = (FunctionAllocation) bo;
            businessName1 = ea.getShortName();
        }
