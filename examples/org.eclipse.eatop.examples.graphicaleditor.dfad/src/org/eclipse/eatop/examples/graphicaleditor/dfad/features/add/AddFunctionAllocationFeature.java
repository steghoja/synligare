 ...
 * 
 */
package org.eclipse.eatop.examples.graphicaleditor.dfad.features.add;
...
public class AddFunctionAllocationFeature extends AbstractAddFeature {
	private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(
			98, 131, 167);

	public AddFunctionAllocationFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context instanceof IAddConnectionContext
				&& context.getNewObject() instanceof FunctionAllocation) {
			return true;
		}
		return false;
	}
	...
	public PictogramElement add(IAddContext context) {
		...
		// RequirementsLink addedReqLink = (RequirementsLink)
		...
		text.setValue("+functionAllocation");
