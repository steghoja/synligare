...
public class AddProcessFaultPrototypeFeature extends
		AbstractAddShapeFeature {
	private static final IColorConstant ProcessFaultPrototype_TEXT_FOREGROUND = IColorConstant.BLACK;
	...
	public AddProcessFaultPrototypeFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof ProcessFaultPrototype) {
	...
	public PictogramElement add(IAddContext context) {
		ProcessFaultPrototype componentTypeToAdd = (ProcessFaultPrototype) context
				.getNewObject();
		...
		// SHAPE WITH TEXT for EAPackageType
		{
			...
			Text text1 = gaService.createText(shape, componentTypeToAdd
					.eClass().getName());
			text1.setForeground(manageColor(ProcessFaultPrototype_TEXT_FOREGROUND));
