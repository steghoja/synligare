...
public class AddFaultFailurePropagationLinkFeature extends AbstractAddShapeFeature {
	...
	public AddFaultFailurePropagationLinkFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		// check if user wants to add a FaultFailurePropagationLink
		if (context.getNewObject() instanceof FaultFailurePropagationLink) {
	...
	public PictogramElement add(IAddContext context) {
		FaultFailurePropagationLink componentTypeToAdd = (FaultFailurePropagationLink) context.getNewObject();
