...
import org.eclipse.graphiti.util.IColorConstant;
	...
	public class AddErrorBehaviorToProcessFaultPrototypeFeature extends AbstractAddFeature {
		 private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(98, 131, 167);
			public AddErrorBehaviorToProcessFaultPrototypeFeature(IFeatureProvider fp) {
				super(fp);
			}
