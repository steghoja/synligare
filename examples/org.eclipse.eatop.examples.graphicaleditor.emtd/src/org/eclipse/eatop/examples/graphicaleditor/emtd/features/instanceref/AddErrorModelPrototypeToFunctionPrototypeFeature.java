...
public class AddErrorModelPrototypeToFunctionPrototypeFeature extends AbstractAddFeature {
	private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(98, 131, 167);
	public AddErrorModelPrototypeToFunctionPrototypeFeature(IFeatureProvider fp) {
		super(fp);
	}
