...
public class RemoveErrorBehaviorToProcessFaultPrototype extends DefaultRemoveFeature {

	public RemoveErrorBehaviorToProcessFaultPrototype(IFeatureProvider fp) {
		super(fp);
	}
	@Override
	public void preRemove(IRemoveContext context) {
		...
		Assert.isTrue(getBusinessObjectForPictogramElement(element.getEnd().getParent()) 
				instanceof ProcessFaultPrototype, "The start element isn't a ProcessFaultPrototype!");
		ProcessFaultPrototype target = (ProcessFaultPrototype) getBusinessObjectForPictogramElement(element.getEnd().getParent());
