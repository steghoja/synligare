...
public class CreateProcessFaultPrototypeFeature extends
		AbstractCreateFeature 
		{
	private static final String TITLE = "Create Process Fault Prototype ";

	private static final String USER_QUESTION = "Enter new Process Fault Prototype name";

	public CreateProcessFaultPrototypeFeature(IFeatureProvider fp) 
	{
		super(fp, "ProcessFaultPrototype ",
				"Create Process Fault Prototype");
	}

	@Override
	public String getCreateImageId() 
	{
		return EMTDImageProvider.PROCESS_FAULT_PROTOTYPE;
	}
	...
	public Object[] create(ICreateContext context) 
	{
		...
		ProcessFaultPrototype newQualReq = Eastadl21Factory.eINSTANCE
				.createProcessFaultPrototype();
		...
		EReference referenceId = Eastadl21Factory.eINSTANCE.getEastadl21Package().getErrorModelType_ProcessFault();
