...
public class DeleteFaultFailurePortsFeature extends DefaultDeleteFeature {

	public DeleteFaultFailurePortsFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public void delete(IDeleteContext context) {
		...
		BoxRelativeAnchor ggggg = (BoxRelativeAnchor) context.getPictogramElement();
		ContainerShape econtainer = (ContainerShape) ggggg.getReferencedGraphicsAlgorithm().eContainer().eContainer();
...
//				FaultFailurePort fp = (FaultFailurePort) pe.getLink().getBusinessObjects().get(0);
				FaultFailurePort fp = (FaultFailurePort) businessObjectsForPictogramElement[0];
