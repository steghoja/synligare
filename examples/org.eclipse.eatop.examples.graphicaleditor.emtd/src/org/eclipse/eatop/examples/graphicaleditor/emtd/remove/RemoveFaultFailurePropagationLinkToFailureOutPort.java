...
public class RemoveFaultFailurePropagationLinkToFailureOutPort extends
		DefaultRemoveFeature {

	public RemoveFaultFailurePropagationLinkToFailureOutPort(IFeatureProvider fp) {
		super(fp);
	}
