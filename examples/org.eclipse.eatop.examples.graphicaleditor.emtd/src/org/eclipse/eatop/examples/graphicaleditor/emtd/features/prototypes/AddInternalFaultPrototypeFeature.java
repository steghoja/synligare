...
public class AddInternalFaultPrototypeFeature extends
		AbstractAddShapeFeature {
	private static final IColorConstant InternalFaultPrototype_TEXT_FOREGROUND = IColorConstant.BLACK;
	...
	public AddInternalFaultPrototypeFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		...
		if (context.getNewObject() instanceof InternalFaultPrototype) {
	...
	public PictogramElement add(IAddContext context) {
		InternalFaultPrototype componentTypeToAdd = (InternalFaultPrototype) context
				.getNewObject();
		...
		// SHAPE WITH TEXT for EAPackageType
		{
			...
			Text text1 = gaService.createText(shape, componentTypeToAdd
					.eClass().getName());
			text1.setForeground(manageColor(InternalFaultPrototype_TEXT_FOREGROUND));
