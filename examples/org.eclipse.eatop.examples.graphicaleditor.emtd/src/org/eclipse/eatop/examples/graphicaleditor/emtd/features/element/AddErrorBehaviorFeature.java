...
public class AddErrorBehaviorFeature extends AbstractAddShapeFeature {
	...
	public AddErrorBehaviorFeature(IFeatureProvider fp) {
	...
	public boolean canAdd(IAddContext context) {
		// check if user wants to add a ErrorBehavior
		if (context.getNewObject() instanceof ErrorBehavior) {
	...
	public PictogramElement add(IAddContext context) {
		ErrorBehavior componentTypeToAdd = (ErrorBehavior) context.getNewObject();
