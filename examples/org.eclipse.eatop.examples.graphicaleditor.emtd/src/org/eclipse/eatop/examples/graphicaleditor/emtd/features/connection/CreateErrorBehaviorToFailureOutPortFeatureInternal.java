...
public class CreateErrorBehaviorToFailureOutPortFeatureInternal extends
		AbstractCreateConnectionFeature {

	public CreateErrorBehaviorToFailureOutPortFeatureInternal(
			IFeatureProvider fp) {
		super(fp, "ErrorBehavior to FailureOutPort (InternalFailure)",
				"Create ErrorBehavior To FailureOutPort (InternalFailure)");
	}
	...
	public boolean canCreate(ICreateConnectionContext context) {
		...
		if (source != null
			...
			EMTDFeatureProvider.internalexternal = 'i';
			return true;
		}
	...
	public Connection create(ICreateConnectionContext context) {
		...
		if (ErrorBehavior != null && FailureOutPort != null) {
			EReference referenceId = Eastadl21Factory.eINSTANCE
					.getEastadl21Package().getErrorBehavior_InternalFailure();
