...
import org.eclipse.graphiti.util.IColorConstant;
	...
	public class AddErrorBehaviorToInternalFaultPrototypeFeature extends AbstractAddFeature {
		 private static final IColorConstant E_REFERENCE_FOREGROUND = new ColorConstant(98, 131, 167);
			public AddErrorBehaviorToInternalFaultPrototypeFeature(IFeatureProvider fp) {
				super(fp);
			}
