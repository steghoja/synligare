...
public class DevelopmentCostAnalysis extends AbstractSummarizingAnalysis {

	/**
	 * Creates a new DevelopmentCostAnalysis with GenericConstraintKind.DEVELOPMENT_COST
	 */
	public DevelopmentCostAnalysis(){
		genericConstraintKind = GenericConstraintKind.DEVELOPMENT_COST;
	}
	...
	protected String successfulLimitedResult(double limit, double value) {
		return "Development cost: " + value + " / " + limit;
	}
	...
	protected String unlimitedResult(double value) {
		return "Total development cost: " + value;
	}
