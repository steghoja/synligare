...
public class TimeRedundancyAnalysis extends AbstractSummarizingAnalysis {

	/**
	 * Default constructor
	 */
	public TimeRedundancyAnalysis() {
		genericConstraintKind = GenericConstraintKind.TIME_REDUNDANCY;
	}
	...
	protected String successfulLimitedResult(double limit, double value) {
		return "Time redundancy: " + value + " / " + limit;
	}
	...
	protected String unlimitedResult(double value) {
		return "Total time redundancy: " + value;
	}
