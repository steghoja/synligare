...
public class MinorIncreaseVersionAction implements IObjectActionDelegate {
	private Shell shell;
	...
	public MinorIncreaseVersionAction() {
						...
						for(UserElementType uaType:uaTypes){
							...
							for(UserAttributeDefinition uaDefinition: uaDefinitions){
								if(uaDefinition.getShortName().equals("Version")){
									...
									float newValueInt = round((float) (versionValue + 0.1),1);
