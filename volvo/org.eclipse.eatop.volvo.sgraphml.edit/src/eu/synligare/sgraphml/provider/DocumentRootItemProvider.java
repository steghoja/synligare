...
/**
 * This is the item provider adapter for a {@link eu.synligare.sgraphml.DocumentRoot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentRootItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SgraphmlPackage.Literals.DOCUMENT_ROOT__GROUP_NODE);
			childrenFeatures.add(SgraphmlPackage.Literals.DOCUMENT_ROOT__POLY_LINE_EDGE);
			childrenFeatures.add(SgraphmlPackage.Literals.DOCUMENT_ROOT__PORT_NODE);
			childrenFeatures.add(SgraphmlPackage.Literals.DOCUMENT_ROOT__RESOURCES);
			childrenFeatures.add(SgraphmlPackage.Literals.DOCUMENT_ROOT__SCALED_ICON);
			childrenFeatures.add(SgraphmlPackage.Literals.DOCUMENT_ROOT__SHAPE_NODE);
		}
