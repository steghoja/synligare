...
/**
 * This is the item provider adapter for a {@link eu.synligare.sgraphml.ShapeType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShapeTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ShapeType_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ShapeType_type_feature", "_UI_ShapeType_type"),
				 SgraphmlPackage.Literals.SHAPE_TYPE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ShapeTypeType labelValue = ((ShapeType)object).getType();
