...
/**
 * This is the item provider adapter for a {@link org.graphdrawing.graphml.xmlns.PortType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PortTypeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PortType_desc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PortType_desc_feature", "_UI_PortType_type"),
				 XmlnsPackage.Literals.PORT_TYPE__DESC,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XmlnsPackage.Literals.PORT_TYPE__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(XmlnsPackage.Literals.PORT_TYPE__GROUP);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(XmlnsPackage.Literals.PORT_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(XmlnsPackage.Literals.PORT_TYPE__DATA,
		...
		newChildDescriptors.add
			(createChildParameter
				(XmlnsPackage.Literals.PORT_TYPE__GROUP,
				 FeatureMapUtil.createEntry
					(XmlnsPackage.Literals.PORT_TYPE__PORT,
