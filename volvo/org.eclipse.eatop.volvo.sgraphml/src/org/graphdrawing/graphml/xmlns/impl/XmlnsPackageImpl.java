...
import eu.synligare.sgraphml.impl.SgraphmlPackageImpl;
...
import org.graphdrawing.graphml.xmlns.DataExtensionType1;
...
public class XmlnsPackageImpl extends EPackageImpl implements XmlnsPackage {
	 ...
	 * @generated
	 */
	private EClass dataExtensionType1EClass = null;
	...
	public static XmlnsPackage init() {
		...
		SgraphmlPackageImpl theSgraphmlPackage = (SgraphmlPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(SgraphmlPackage.eNS_URI) instanceof SgraphmlPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(SgraphmlPackage.eNS_URI) : SgraphmlPackage.eINSTANCE);
	 ...
	 * @generated
	 */
	public EClass getDataExtensionType1() {
		return dataExtensionType1EClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getDataExtensionType1_Any() {
		return (EAttribute)dataExtensionType1EClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getEdgeType_ElementType() {
	...
	public EAttribute getEdgeType_Targetport() {
		return (EAttribute)edgeTypeEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EAttribute getKeyType_SgraphmlType() {
	 ...
	 * @generated
	 */
	public EAttribute getNodeType_ElementType() {
	...
	public void createPackageContents() {
		...
		dataExtensionType1EClass = createEClass(DATA_EXTENSION_TYPE1);
		createEAttribute(dataExtensionType1EClass, DATA_EXTENSION_TYPE1__ANY);
		...
		createEAttribute(edgeTypeEClass, EDGE_TYPE__ELEMENT_TYPE);
		...
		createEAttribute(keyTypeEClass, KEY_TYPE__SGRAPHML_TYPE);
		...
		createEAttribute(nodeTypeEClass, NODE_TYPE__ELEMENT_TYPE);
	...
	public void initializePackageContents() {
		...
		dataExtensionType1EClass.getESuperTypes().add(this.getDataExtensionType());
		dataTypeEClass.getESuperTypes().add(this.getDataExtensionType1());
		defaultTypeEClass.getESuperTypes().add(this.getDataExtensionType1());
		...
		initEClass(dataExtensionType1EClass, DataExtensionType1.class, "DataExtensionType1", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDataExtensionType1_Any(), ecorePackage.getEFeatureMapEntry(), "any", null, 0, -1, DataExtensionType1.class, IS_TRANSIENT, IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEdgeType_ElementType(), theXMLTypePackage.getString(), "elementType", null, 0, 1, EdgeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getKeyType_SgraphmlType(), theXMLTypePackage.getString(), "sgraphmlType", null, 0, 1, KeyType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getNodeType_ElementType(), theXMLTypePackage.getString(), "elementType", null, 0, 1, NodeType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(keyTypeTypeEEnum, KeyTypeType.COMPLEX);
