...
public class XmlnsFactoryImpl extends EFactoryImpl implements XmlnsFactory {
	...
	public static XmlnsFactory init() {
		try {
			XmlnsFactory theXmlnsFactory = (XmlnsFactory)EPackage.Registry.INSTANCE.getEFactory(XmlnsPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case XmlnsPackage.DATA_EXTENSION_TYPE1: return createDataExtensionType1();
	 ...
	 * @generated
	 */
	public DataExtensionType1 createDataExtensionType1() {
		DataExtensionType1Impl dataExtensionType1 = new DataExtensionType1Impl();
		return dataExtensionType1;
	}
