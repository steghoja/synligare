 ...
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.EdgeTypeImpl#getElementType <em>Element Type</em>}</li>
...
public class EdgeTypeImpl extends MinimalEObjectImpl.Container implements EdgeType {
	...
	public void setElementType(String newElementType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.EDGE_TYPE__ELEMENT_TYPE, oldElementType, elementType));
	}
