 ...
 *   <li>{@link org.graphdrawing.graphml.xmlns.impl.NodeTypeImpl#getElementType <em>Element Type</em>}</li>
...
public class NodeTypeImpl extends MinimalEObjectImpl.Container implements NodeType {
	...
	public EList<GraphType> getGraph() {
		return getGroup().list(XmlnsPackage.Literals.NODE_TYPE__GRAPH);
	}
	...
	public void setElementType(String newElementType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XmlnsPackage.NODE_TYPE__ELEMENT_TYPE, oldElementType, elementType));
	}
