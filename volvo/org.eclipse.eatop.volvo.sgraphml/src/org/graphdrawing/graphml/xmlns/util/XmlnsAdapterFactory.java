...
public class XmlnsAdapterFactory extends AdapterFactoryImpl {
	...
	protected XmlnsSwitch<Adapter> modelSwitch =
		new XmlnsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDataExtensionType1(DataExtensionType1 object) {
				return createDataExtensionType1Adapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.graphdrawing.graphml.xmlns.DataExtensionType1 <em>Data Extension Type1</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
