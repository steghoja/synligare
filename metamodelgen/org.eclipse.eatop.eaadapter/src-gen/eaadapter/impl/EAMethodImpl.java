...
public class EAMethodImpl extends EObjectImpl implements EAMethod {
	...
	public EAElement getElement() {
		if (eContainerFeatureID() != EaadapterPackage.EA_METHOD__ELEMENT) return null;
	...
	public EList<EAParameter> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentWithInverseEList<EAParameter>(EAParameter.class, this, EaadapterPackage.EA_METHOD__PARAMETERS, EaadapterPackage.EA_PARAMETER__METHOD);
		}
		return parameters;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EAClassifierIDLong.class) {
			switch (derivedFeatureID) {
				case EaadapterPackage.EA_METHOD__CLASSIFIER_ID: return AbstracthierachyPackage.EA_CLASSIFIER_ID_LONG__CLASSIFIER_ID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EAClassifierIDLong.class) {
			switch (baseFeatureID) {
				case AbstracthierachyPackage.EA_CLASSIFIER_ID_LONG__CLASSIFIER_ID: return EaadapterPackage.EA_METHOD__CLASSIFIER_ID;
				default: return -1;
			}
		}
