...
public class EAConnectorEndImpl extends EObjectImpl implements EAConnectorEnd {
	...
	/**
	 * The default value of the '{@link #getIsChangable() <em>Is Changable</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIsChangable()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getIsChangable() <em>Is Changable</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getIsChangable()
	 * @generated
	...
	public EList<EARoleTag> getTaggedValues() {
		if (taggedValues == null) {
			taggedValues = new EObjectContainmentWithInverseEList<EARoleTag>(EARoleTag.class, this, EaadapterPackage.EA_CONNECTOR_END__TAGGED_VALUES, EaadapterPackage.EA_ROLE_TAG__CONNECTOR_END);
		}
		return taggedValues;
	}
	...
	public boolean validate(DiagnosticChain diagnostic, Map<Object, Object> context) {
		...
		if (ValidationHelper.hasLeadingOrTrailingSpaces(this.getRole())) {
			if (diagnostic != null) {
				diagnostic.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 "Connector role \""+this.getRole()+"\" has leading/trailing whitespaced!",
						 new Object [] { this }));
			}
			isValid = false;
		}
				...
				diagnostic.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 AbstracthierachyValidator.DIAGNOSTIC_SOURCE,
						 AbstracthierachyValidator.EA_NAMED_ELEMENT__VALIDATE,
						 "You have a rolename '"+this.getRole()+"', but there is no cardinality!",
						 new Object [] { this }));
			}
			isValid = false;
		}		
					...
					diagnostic.add
						(new BasicDiagnostic
							(Diagnostic.WARNING,
							 AbstracthierachyValidator.DIAGNOSTIC_SOURCE,
							 AbstracthierachyValidator.EA_NAMED_ELEMENT__VALIDATE,
							 String.format("The cardinality on containment references shall be [0..1] but it is not set"),
							 new Object [] { this }));
				}
				isValid = false;			
			}
	...
	private boolean isContainmentReference() {
		if (this.getAggregation() == T_ConnectorAggregation.COMPOSITE)
			return true;
		else
			return false;
	}
	...
	private boolean hasCardinality() {
		if (this.getCardinality().length() > 0)
			return true;
		else
			return false;
	}
