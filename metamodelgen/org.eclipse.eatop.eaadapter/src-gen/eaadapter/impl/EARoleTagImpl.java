...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EA Role Tag</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EARoleTagImpl extends EObjectImpl implements EARoleTag {
	...
	public EAConnectorEnd getConnectorEnd() {
		if (eContainerFeatureID() != EaadapterPackage.EA_ROLE_TAG__CONNECTOR_END) return null;
	...
	public void setConnectorEnd(EAConnectorEnd newConnectorEnd) {
		if (newConnectorEnd != eInternalContainer() || (eContainerFeatureID() != EaadapterPackage.EA_ROLE_TAG__CONNECTOR_END && newConnectorEnd != null)) {
			...
			if (newConnectorEnd != null)
				msgs = ((InternalEObject)newConnectorEnd).eInverseAdd(this, EaadapterPackage.EA_CONNECTOR_END__TAGGED_VALUES, EAConnectorEnd.class, msgs);
