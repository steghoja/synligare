...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EA Connector Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class EAConnectorConstraintImpl extends EObjectImpl implements EAConnectorConstraint {
	...
	public EAConnector getConnector() {
		if (eContainerFeatureID() != EaadapterPackage.EA_CONNECTOR_CONSTRAINT__CONNECTOR) return null;
	...
	public void setConnector(EAConnector newConnector) {
		if (newConnector != eInternalContainer() || (eContainerFeatureID() != EaadapterPackage.EA_CONNECTOR_CONSTRAINT__CONNECTOR && newConnector != null)) {
