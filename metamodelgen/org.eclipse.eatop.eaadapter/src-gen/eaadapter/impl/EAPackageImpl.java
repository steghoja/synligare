...
public class EAPackageImpl extends EObjectImpl implements EAPackage {
	...
	public EList<EAElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentWithInverseEList<EAElement>(EAElement.class, this, EaadapterPackage.EA_PACKAGE__ELEMENTS, EaadapterPackage.EA_ELEMENT__PACKAGE);
		}
		return elements;
	}
	...
	public EList<EAPackage> getPackages() {
		if (packages == null) {
			packages = new EObjectContainmentWithInverseEList<EAPackage>(EAPackage.class, this, EaadapterPackage.EA_PACKAGE__PACKAGES, EaadapterPackage.EA_PACKAGE__SUPER_PACKAGE);
		}
		return packages;
	}
	...
	public EAPackage getSuperPackage() {
		if (eContainerFeatureID() != EaadapterPackage.EA_PACKAGE__SUPER_PACKAGE) return null;
				...
				diagnostic.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 ...
						 EaadapterValidator.EA_PACKAGE__VALIDATE,
						 "The package's name \""+this.getName()+"\" has leading/trailing whitespaces!",
						 new Object [] { this }));
			}
			isValid = false;			
		}		
				...
				diagnostic.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EaadapterValidator.DIAGNOSTIC_SOURCE,
						 EaadapterValidator.EA_PACKAGE__VALIDATE,
						 "The package's name is not well formed!",
						 new Object [] { this }));
			}
			isValid = false;
		}
					...
					diagnostic.add
						(new BasicDiagnostic
							(Diagnostic.ERROR,
							 EaadapterValidator.DIAGNOSTIC_SOURCE,
							 EaadapterValidator.EA_PACKAGE__VALIDATE,
							 "There may not be two packages named '"+duplicateName+"'!",
							 new Object [] { this }));
				}
				isValid = false;				
			}
					...
					diagnostic.add
						(new BasicDiagnostic
							(Diagnostic.ERROR,
							 EaadapterValidator.DIAGNOSTIC_SOURCE,
							 EaadapterValidator.EA_PACKAGE__VALIDATE,
							 "There may not be two elements named '"+duplicateName+"'!",
							 new Object [] { this }));
				}
				isValid = false;				
			}
	...
	private List<String> getDuplicatePackages() {
		...
		for (EAPackage p : this.getPackages())
			names.add(p.getName());
	...
	private List<String> getDuplicateElements() {
		...
		for (EAElement element : this.getElements()) {
