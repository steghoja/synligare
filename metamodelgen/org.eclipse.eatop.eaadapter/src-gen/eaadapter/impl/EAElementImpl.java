...
public class EAElementImpl extends EObjectImpl implements EAElement {
	...
	/**
	 * The cached value of the '{@link #getGenfile() <em>Genfile</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getGenfile()
	 * @generated
	...
	public EAElement getElement() {
		if (eContainerFeatureID() != EaadapterPackage.EA_ELEMENT__ELEMENT) return null;
	...
	public EAPackage getPackage() {
		if (eContainerFeatureID() != EaadapterPackage.EA_ELEMENT__PACKAGE) return null;
	...
	public EList<EAAttribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentWithInverseEList<EAAttribute>(EAAttribute.class, this, EaadapterPackage.EA_ELEMENT__ATTRIBUTES, EaadapterPackage.EA_ATTRIBUTE__ELEMENT);
		}
		return attributes;
	}
	...
	public EList<EAConnector> getConnectors() {
		if (connectors == null) {
			connectors = new EObjectContainmentWithInverseEList<EAConnector>(EAConnector.class, this, EaadapterPackage.EA_ELEMENT__CONNECTORS, EaadapterPackage.EA_CONNECTOR__CLIENT);
		}
		return connectors;
	}
	...
	public EList<EAElement> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentWithInverseEList<EAElement>(EAElement.class, this, EaadapterPackage.EA_ELEMENT__ELEMENTS, EaadapterPackage.EA_ELEMENT__ELEMENT);
		}
		return elements;
	}
	...
	public EList<EAMethod> getMethods() {
		if (methods == null) {
			methods = new EObjectContainmentWithInverseEList<EAMethod>(EAMethod.class, this, EaadapterPackage.EA_ELEMENT__METHODS, EaadapterPackage.EA_METHOD__ELEMENT);
		}
		return methods;
	}
	...
	public boolean validate(DiagnosticChain diagnostic, Map<Object, Object> context) {
		...
		if (ValidationHelper.hasLeadingOrTrailingSpaces(this.getName())) {
			if (diagnostic != null) {
				diagnostic.add
					(new BasicDiagnostic
						(Diagnostic.WARNING,
						 EaadapterValidator.DIAGNOSTIC_SOURCE,
						 EaadapterValidator.EA_ELEMENT__VALIDATE,
						 "The element's name \""+this.getName()+"\" has leading/trailing whitespaces!",
						 new Object [] { this }));
			}
			isValid = false;			
		}		
		
		if (!ValidationHelper.isNameWellFormed(this.getName())) {
			if (diagnostic != null) {
				diagnostic.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EaadapterValidator.DIAGNOSTIC_SOURCE,
						 EaadapterValidator.EA_ELEMENT__VALIDATE,
						 "The element's name is not well formed!",
						 new Object [] { this }));
			}
			isValid = false;
		}
				...
				diagnostic.add
					(new BasicDiagnostic
						(Diagnostic.ERROR,
						 EaadapterValidator.DIAGNOSTIC_SOURCE,
						 EaadapterValidator.EA_ELEMENT__VALIDATE,
						 String.format("Element '%s' has %d sub-element(s): (%s)! Is this a modelling fault?! We don't know how to handle it!", this.getName(), this.getElements().size(), invalidElementsString(this)),
						 new Object [] { this }));
			}
			isValid = false;
		}		
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == EAVersiondElement.class) {
			switch (derivedFeatureID) {
				case EaadapterPackage.EA_ELEMENT__VERSION: return AbstracthierachyPackage.EA_VERSIOND_ELEMENT__VERSION;
				default: return -1;
			}
		}
		if (baseClass == EAOwnedElement.class) {
			switch (derivedFeatureID) {
				case EaadapterPackage.EA_ELEMENT__AUTHOR: return AbstracthierachyPackage.EA_OWNED_ELEMENT__AUTHOR;
				case EaadapterPackage.EA_ELEMENT__IS_LOCKED: return AbstracthierachyPackage.EA_OWNED_ELEMENT__IS_LOCKED;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == EAVersiondElement.class) {
			switch (baseFeatureID) {
				case AbstracthierachyPackage.EA_VERSIOND_ELEMENT__VERSION: return EaadapterPackage.EA_ELEMENT__VERSION;
				default: return -1;
			}
		}
		if (baseClass == EAOwnedElement.class) {
			switch (baseFeatureID) {
				case AbstracthierachyPackage.EA_OWNED_ELEMENT__AUTHOR: return EaadapterPackage.EA_ELEMENT__AUTHOR;
				case AbstracthierachyPackage.EA_OWNED_ELEMENT__IS_LOCKED: return EaadapterPackage.EA_ELEMENT__IS_LOCKED;
				default: return -1;
			}
		}
