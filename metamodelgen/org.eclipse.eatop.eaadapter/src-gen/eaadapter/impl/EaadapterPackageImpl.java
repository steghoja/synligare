...
public class EaadapterPackageImpl extends EPackageImpl implements EaadapterPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link EaadapterPackage#eINSTANCE} when that field is accessed.
	...
	public static EaadapterPackage init() {
		if (isInited) return (EaadapterPackage)EPackage.Registry.INSTANCE.getEPackage(EaadapterPackage.eNS_URI);

		// Obtain or create and register package
		EaadapterPackageImpl theEaadapterPackage = (EaadapterPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof EaadapterPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new EaadapterPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getEAAttribute_Collection(), ecorePackage.getEBooleanObject(), "collection", null, 0, 1, EAAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAAttribute_Ordered(), ecorePackage.getEBooleanObject(), "ordered", null, 0, 1, EAAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAAttribute_Derived(), ecorePackage.getEBooleanObject(), "derived", null, 0, 1, EAAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAAttribute_Visibility(), ecorePackage.getEString(), "visibility", null, 0, 1, EAAttribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEAConnector_Client(), this.getEAElement(), this.getEAElement_Connectors(), "client", null, 1, 1, EAConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEAConnector_Supplier(), this.getEAElement(), null, "supplier", null, 1, 1, EAConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEAConnector_Constraints(), this.getEAConnectorConstraint(), this.getEAConnectorConstraint_Connector(), "constraints", null, 0, -1, EAConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAConnector_ClientID(), ecorePackage.getELong(), "clientID", null, 0, 1, EAConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnector_SupplierID(), ecorePackage.getELong(), "supplierID", null, 0, 1, EAConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnector_EventFlags(), ecorePackage.getEString(), "eventFlags", null, 0, 1, EAConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnector_StyleEx(), ecorePackage.getEString(), "styleEx", null, 0, 1, EAConnector.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAConnector_Derived(), ecorePackage.getEBoolean(), "derived", null, 0, 1, EAConnector.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEAElement_Connectors(), this.getEAConnector(), this.getEAConnector_Client(), "connectors", null, 0, -1, EAElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEAElement_AllConnectors(), this.getEAConnector(), null, "allConnectors", null, 0, -1, EAElement.class, IS_TRANSIENT, IS_VOLATILE, !IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAElement_Visibility(), ecorePackage.getEString(), "visibility", null, 0, 1, EAElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAElement_IsAbstract(), ecorePackage.getEBoolean(), "isAbstract", null, 0, 1, EAElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAElement_IsActive(), ecorePackage.getEBoolean(), "isActive", null, 0, 1, EAElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEAElement_Constraints(), this.getEAConstraint(), null, "constraints", null, 0, -1, EAElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAElement_MetaType(), ecorePackage.getEString(), "metaType", null, 0, 1, EAElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEAPackage_Packages(), this.getEAPackage(), this.getEAPackage_SuperPackage(), "packages", null, 0, -1, EAPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEAPackage_SuperPackage(), this.getEAPackage(), this.getEAPackage_Packages(), "superPackage", null, 0, 1, EAPackage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEARepository_File(), theDatatypesPackage.getFile(), "file", null, 0, 1, EARepository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = addEOperation(eaRepositoryEClass, this.getEAElement(), "getEAElementByGUID", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "guid", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = addEOperation(eaRepositoryEClass, this.getEAElement(), "getEAElementByID", 0, -1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getELong(), "id", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getEAConnectorEnd_TaggedValues(), this.getEARoleTag(), this.getEARoleTag_ConnectorEnd(), "TaggedValues", null, 0, -1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAConnectorEnd_Visibility(), ecorePackage.getEString(), "visibility", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAConnectorEnd_RoleNote(), ecorePackage.getEString(), "roleNote", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnectorEnd_Containment(), ecorePackage.getEString(), "containment", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnectorEnd_Aggregation(), theDatatypesPackage.getT_ConnectorAggregation(), "aggregation", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnectorEnd_Ordering(), ecorePackage.getELong(), "ordering", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAConnectorEnd_Constraint(), ecorePackage.getEString(), "constraint", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnectorEnd_IsNavigable(), ecorePackage.getEBoolean(), "isNavigable", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnectorEnd_IsChangable(), ecorePackage.getEString(), "isChangable", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAConnectorEnd_Derived(), ecorePackage.getEBoolean(), "derived", null, 0, 1, EAConnectorEnd.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eaConnectorConstraintEClass, EAConnectorConstraint.class, "EAConnectorConstraint", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEAConnectorConstraint_ConnectorID(), ecorePackage.getELong(), "connectorID", null, 0, 1, EAConnectorConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnectorConstraint_Type(), ecorePackage.getEString(), "type", null, 0, 1, EAConnectorConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEAConnectorConstraint_Connector(), this.getEAConnector(), this.getEAConnector_Constraints(), "connector", null, 0, 1, EAConnectorConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConnectorConstraint_EaLink(), theDatatypesPackage.getT_ConnectorConstraint(), "eaLink", null, 0, 1, EAConnectorConstraint.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eaRoleTagEClass, EARoleTag.class, "EARoleTag", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEARoleTag_BaseClass(), ecorePackage.getEString(), "baseClass", null, 0, 1, EARoleTag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEARoleTag_ElementGUID(), ecorePackage.getEString(), "elementGUID", null, 0, 1, EARoleTag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEARoleTag_PropertyGUID(), ecorePackage.getEString(), "propertyGUID", null, 0, 1, EARoleTag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEARoleTag_Tag(), ecorePackage.getEString(), "tag", null, 0, 1, EARoleTag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEARoleTag_ConnectorEnd(), this.getEAConnectorEnd(), this.getEAConnectorEnd_TaggedValues(), "connectorEnd", null, 0, 1, EARoleTag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEARoleTag_EaLink(), theDatatypesPackage.getT_RoleTag(), "eaLink", null, 0, 1, EARoleTag.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEARoleTag_Value(), ecorePackage.getEString(), "value", null, 0, 1, EARoleTag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eaConstraintEClass, EAConstraint.class, "EAConstraint", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEAConstraint_Status(), ecorePackage.getEString(), "status", null, 0, 1, EAConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConstraint_Type(), ecorePackage.getEString(), "type", null, 0, 1, EAConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getEAConstraint_Weight(), ecorePackage.getEString(), "weight", null, 0, 1, EAConstraint.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
