...
public class EaadapterSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case EaadapterPackage.EA_METHOD: {
				...
				if (result == null) result = caseEAClassifierIDLong(eaMethod);
			...
			case EaadapterPackage.EA_PARAMETER: {
				...
				if (result == null) result = caseEAClassifierIDLong(eaParameter);
				if (result == null) result = caseEATypedElement(eaParameter);
				if (result == null) result = caseEAStereotypedElement(eaParameter);
			...
			case EaadapterPackage.EA_CONNECTOR_END: {
				...
				if (result == null) result = caseEANamedElement(eaConnectorEnd);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EaadapterPackage.EA_CONNECTOR_CONSTRAINT: {
				...
				if (result == null) result = caseEANamedElement(eaConnectorConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EaadapterPackage.EA_ROLE_TAG: {
				...
				if (result == null) result = caseEANamedElement(eaRoleTag);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EaadapterPackage.EA_CONSTRAINT: {
				...
				if (result == null) result = caseEANamedElement(eaConstraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EA Role Tag</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EA Constraint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
