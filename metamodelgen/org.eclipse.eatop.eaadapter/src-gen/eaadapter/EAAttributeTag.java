...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EA Attribute Tag</b></em>'. <!-- end-user-doc
 ...
 * <ul>
 * <li>{@link eaadapter.EAAttributeTag#getEaLink <em>Ea Link</em>}</li>
 * </ul>
 * </p>
 * 
 * @see eaadapter.EaadapterPackage#getEAAttributeTag()
 * @model
 * @generated
 */
public interface EAAttributeTag extends EATaggedElement {
	 ...
	 * @see eaadapter.EaadapterPackage#getEAAttributeTag_EaLink()
	 * @model dataType="eaadapter.datatypes.T_AttributeTag" transient="true"
	 * @generated
	 */
	AttributeTag getEaLink();

	/**
	 * Sets the value of the '{@link eaadapter.EAAttributeTag#getEaLink <em>Ea Link</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
