...
public interface EARepository extends EObject {
	...
	/**
	 * Sets the value of the '{@link eaadapter.EARepository#getEaLink <em>Ea Link</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link eaadapter.EARepository#getFile <em>File</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link eaadapter.EAPackage}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * <!-- begin-model-doc -->
	 * <div class='userdoc'>
	 * This is the method which initializes the model.<br>
	 ...
	 * This two step approach is necessary since all classes and packages must be present
	 * before the connectors can be added.
	 * </div>
	 * <!-- end-model-doc -->
	 ...
	 * <!-- begin-model-doc -->
	 * <div class='userdoc'>
	 * This method returns an <code>EANamedElement</code> by its global unique identifier <code>GUID</code>.
	 * </div>
	 * <!-- end-model-doc -->
	 * @model
	 * @generated
	 ...
	 * <!-- begin-model-doc -->
	 * <div class='userdoc'>
	 * This method returns an <code>EAElement</code> by its global unique identifier <code>GUID</code>.
	 * </div>
	 * <!-- end-model-doc -->
	 * @model
	 * @generated
	 ...
	 * <!-- begin-model-doc -->
	 * <div class='userdoc'>
	 * This method returns a list of <code>EANamedElement</code> identified by its id <code>ID</code>.<br>
	 * Note that an element's <code>ID</code> is only unique within its current model. Hence, it is possible that an
	 * <code>ID</code> can appear more than once.
	 * </div>
	 * <!-- end-model-doc -->
	 * @model
	 * @generated
	 ...
	 * <!-- begin-model-doc -->
	 * <div class='userdoc'>
	 * This method returns a list of <code>EAElement</code> identified by its id <code>ID</code>.<br>
	 * Note that an element's <code>ID</code> is only unique within its current model. Hence, it is possible that an
	 * <code>ID</code> can appear more than once.
	 * </div>
	 * <!-- end-model-doc -->
