...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EA Method Tag</b></em>'. <!-- end-user-doc -->
...
public interface EAMethodTag extends EATaggedElement {
	...
	/**
	 * Sets the value of the '{@link eaadapter.EAMethodTag#getEaLink <em>Ea Link</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @param value
