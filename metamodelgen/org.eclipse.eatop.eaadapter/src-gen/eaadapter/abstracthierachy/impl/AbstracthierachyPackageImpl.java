...
public class AbstracthierachyPackageImpl extends EPackageImpl implements AbstracthierachyPackage {
	...
	public void initializePackageContents() {
		...
		eaClassifierIDLongEClass.getESuperTypes().add(this.getEATypedElement());
		eaModifiableElementEClass.getESuperTypes().add(this.getEATypedElement());
		...
		initEAttribute(getEANamedElement_Id(), ecorePackage.getELong(), "id", null, 0, 1, EANamedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getEAStereotypedElement_StereotypeEx(), ecorePackage.getEString(), "stereotypeEx", null, 0, 1, EAStereotypedElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
