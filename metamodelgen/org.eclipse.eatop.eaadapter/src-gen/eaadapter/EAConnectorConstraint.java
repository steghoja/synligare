...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EA Connector Constraint</b></em>'. <!--
 * end-user-doc --> <!-- begin-model-doc --> <div class='userdoc'> A Connector Constraint. <br>
 * <br>
...
public interface EAConnectorConstraint extends EANamedElement {
	...
	/**
	 * Returns the value of the '<em><b>Connector</b></em>' container reference. It is bidirectional and its opposite is
	 * '{@link eaadapter.EAConnector#getConstraints <em>Constraints</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Connector</em>' container reference isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link eaadapter.EAConnectorConstraint#getConnector <em>Connector</em>}' container
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Connector</em>' container reference.
	 * @see #getConnector()
	 * @generated
	 */
