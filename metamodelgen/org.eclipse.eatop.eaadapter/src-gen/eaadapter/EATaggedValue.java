...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>EA Tagged Value</b></em>'. <!-- end-user-doc -->
 ...
 * <ul>
 * <li>{@link eaadapter.EATaggedValue#getEaLink <em>Ea Link</em>}</li>
 * </ul>
 * </p>
 * 
 * @see eaadapter.EaadapterPackage#getEATaggedValue()
 * @model
 * @generated
 */
public interface EATaggedValue extends EATaggedElement {
	 ...
	 * @see eaadapter.EaadapterPackage#getEATaggedValue_EaLink()
	 * @model dataType="eaadapter.datatypes.T_TaggedValue" transient="true"
	 * @generated
	 */
	TaggedValue getEaLink();

	/**
	 * Sets the value of the '{@link eaadapter.EATaggedValue#getEaLink <em>Ea Link</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @param value
